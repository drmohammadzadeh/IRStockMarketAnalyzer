# 📊 شناسنامه و داشبورد تحلیلی نماد زهلال (زلال ایران)
...
| **آخرین قیمت معامله** | **48,500 ریال** | ثبت نوسانات پایان بازار ۱۴۰۵/۰۶/۱۰ |
| **محدوده خرید بهینه** | **47,530 تا 49,470 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **50,890 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **55,979 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **46,213 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
