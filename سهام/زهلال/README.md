...
| **آخرین قیمت معامله** | **51,940 ریال** | ثبت نوسانات پایان بازار 1405/06/15 |
| **محدوده خرید بهینه** | **50,901 تا 52,979 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **52,060 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **57,266 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **47,077 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.02** | 🔴 نیازمند احتیاط (R/R < 1.5) |
