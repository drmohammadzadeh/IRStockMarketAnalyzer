...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **39,264,000 میلیون ریال** (معادل **3.93 همت** / 39,264,000,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **10,601,280 میلیون ریال** (معادل **1.06 همت** / 10,601,280,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **7,550,769 میلیون ریال** (معادل **755.1 میلیارد تومان** / 7,550,769,230,769 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **17,528,571 میلیون ریال** (معادل **1.75 همت** / 17,528,571,428,571 ریال)
...
| **سود هر سهم دوره اخیر (EPS ttm)** | **7,551 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **8,072 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **5,286 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
