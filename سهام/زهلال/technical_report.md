...
**آخرین قیمت معاملاتی:** 48,500 ریال | **دامنه روز:** 48,000 تا 49,800 ریال  
**حجم معاملات آخرین روز:** 185,000 برگه سهم (میانگین ۲۰ روزه: 3,886,004)
...
- **دامنه نوسان واقعی (ATR 14):** 1,855 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 47,654 | +1.8% | حمایت پویا |
| **EMA 50** | 45,053 | +7.7% | حمایت میان‌مدت |
| **EMA 100** | 42,284 | +14.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 39,949 | +21.4% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 50,002 ریال
- **باند میانی (SMA 20):** 48,098 ریال
- **باند پایینی (Lower Band):** 46,193 ریال
- **عرض باند (Bandwidth):** 7.9% (سنجش میزان فشردگی نوسانات)
...
- **ابر کومو اسپن A (Senkou Span A):** 48,500 ریال
- **ابر کومو اسپن B (Senkou Span B):** 48,500 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **59.3** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 1114.20 | **خط سیگنال:** 1285.58 | **هیستوگرام:** -171.38
...
| :--- | :--- | :--- | :--- |
| **0.0** | 50,890 | -4.7% | سقف موج (Pivot High) |
| **0.236** | 47,140 | +2.9% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 44,821 | +8.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 42,946 | +12.9% | تراز میانی تعادلی (50.0%) |
| **0.618** | 41,071 | +18.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 38,402 | +26.3% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 35,002 | +38.6% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **1.06** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 3,556 سهم | **سرانه فروش حقیقی:** 3,364 سهم
- **حجم خرید حقیقی:** 160,000 سهم | **حجم خرید حقوقی:** 25,000 سهم
- **حجم فروش حقیقی:** 185,000 سهم | **حجم فروش حقوقی:** 0 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **48,500 ریال** در مقایسه با میانگین ۲۰ روزه (47,654 ریال) و میانگین ۵۰ روزه (45,053 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **59.3** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-171.38** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.06** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **3,556 سهم** ثبت گردیده است.
