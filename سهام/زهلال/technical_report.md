...
**آخرین قیمت معاملاتی:** 51,940 ریال | **دامنه روز:** 50,620 تا 52,060 ریال  
**حجم معاملات آخرین روز:** 2,870,663 برگه سهم (میانگین ۲۰ روزه: 3,646,029)
...
- **سقف ماژور دوره (Swing High):** 52,060 ریال
- **کف ماژور دوره (Swing Low):** 35,002 ریال
- **دامنه نوسان واقعی (ATR 14):** 1,915 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 48,464 | +7.2% | حمایت پویا |
| **EMA 50** | 45,696 | +13.7% | حمایت میان‌مدت |
| **EMA 100** | 42,775 | +21.4% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 40,268 | +29.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 50,957 ریال
- **باند میانی (SMA 20):** 48,680 ریال
- **باند پایینی (Lower Band):** 46,403 ریال
- **عرض باند (Bandwidth):** 9.4% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 49,090 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 47,415 ریال
- **ابر کومو اسپن A (Senkou Span A):** 51,940 ریال
- **ابر کومو اسپن B (Senkou Span B):** 51,940 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **70.2** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 1380.70 | **خط سیگنال:** 1279.16 | **هیستوگرام:** 101.53
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 35,002 و سقف 52,060 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 52,060 | -0.2% | سقف موج (Pivot High) |
| **0.236** | 48,034 | +8.1% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 45,544 | +14.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 43,531 | +19.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 41,518 | +25.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 38,652 | +34.4% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 35,002 | +48.4% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **48,034 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **52,060 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **22.78** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی))
- **سرانه خرید حقیقی:** 11,912 سهم | **سرانه فروش حقیقی:** 523 سهم
- **حجم خرید حقیقی:** 3,287,820 سهم | **حجم خرید حقوقی:** 100,000 سهم
- **حجم فروش حقیقی:** 2,096,424 سهم | **حجم فروش حقوقی:** 1,291,396 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **51,940 ریال** در مقایسه با میانگین ۲۰ روزه (48,464 ریال) و میانگین ۵۰ روزه (45,696 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **70.2** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+101.53** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **22.78** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی)) با سرانه خرید **11,912 سهم** ثبت گردیده است.
