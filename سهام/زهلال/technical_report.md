...
**آخرین قیمت معاملاتی:** 50,550 ریال | **دامنه روز:** 50,280 تا 50,550 ریال  
**حجم معاملات آخرین روز:** 3,387,820 برگه سهم (میانگین ۲۰ روزه: 3,934,072)
...
- **دامنه نوسان واقعی (ATR 14):** 1,924 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 48,098 | +5.1% | حمایت پویا |
| **EMA 50** | 45,441 | +11.2% | حمایت میان‌مدت |
| **EMA 100** | 42,590 | +18.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 40,150 | +25.9% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 50,181 ریال
- **باند میانی (SMA 20):** 48,492 ریال
- **باند پایینی (Lower Band):** 46,802 ریال
- **عرض باند (Bandwidth):** 7.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 48,335 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 46,830 ریال
- **ابر کومو اسپن A (Senkou Span A):** 50,550 ریال
- **ابر کومو اسپن B (Senkou Span B):** 50,550 ریال
...
- **مکدی (MACD 12,26,9):** 1218.04 | **خط سیگنال:** 1253.78 | **هیستوگرام:** -35.74
...
| :--- | :--- | :--- | :--- |
| **0.0** | 50,890 | -0.7% | سقف موج (Pivot High) |
| **0.236** | 47,140 | +7.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 44,821 | +12.8% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 42,946 | +17.7% | تراز میانی تعادلی (50.0%) |
| **0.618** | 41,071 | +23.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 38,402 | +31.6% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 35,002 | +44.4% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **50,550 ریال** در مقایسه با میانگین ۲۰ روزه (48,098 ریال) و میانگین ۵۰ روزه (45,441 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **66.3** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-35.74** نوسان می‌کند.
