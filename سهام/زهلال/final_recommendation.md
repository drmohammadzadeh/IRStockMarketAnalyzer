...
**آخرین قیمت معاملاتی:** 53,490 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.5** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (7.5/۱۰ با وزن ۳۰٪) + تابلوخوانی (10.0/۱۰ با وزن ۲۵٪) + اخبار (6.0/۱۰ با وزن ۱۰٪) |
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **4.0** | افق کوتاه‌مدت (8.8/۱۰) + میان‌مدت (8.5/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=1.21 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **52,420 تا 54,560 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **59,909 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **65,900 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **48,179 ریال** | **-9.9%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 59,909 ریال (بازدهی مورد انتظار: 12.0%)
- **حد ضرر:** 48,179 ریال (حداکثر ریسک: 9.9%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 65,900 ریال (بازدهی مورد انتظار: 23.2%)
- **حد ضرر:** 46,734 ریال (ریسک: 12.6%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 82,375 ریال (بازدهی مورد انتظار: 54.0%)
- **حد ضرر:** 45,197 ریال (ریسک: 15.5%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 73.8 - ATR: 1,895 ریال | اشباع خرید / خنثی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 48,179 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/16 - 09:12`
