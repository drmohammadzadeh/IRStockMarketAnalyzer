...
| **حد سود اول (Target 1)** | **52,060 ریال** | **+0.2%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **57,266 ریال** | **+10.3%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **47,077 ریال** | **-9.4%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 52,060 ریال (بازدهی مورد انتظار: 0.2%)
- **حد ضرر:** 47,077 ریال (حداکثر ریسک: 9.4%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 57,266 ریال (بازدهی مورد انتظار: 10.3%)
- **حد ضرر:** 45,665 ریال (ریسک: 12.1%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 71,582 ریال (بازدهی مورد انتظار: 37.8%)
- **حد ضرر:** 44,192 ریال (ریسک: 14.9%)
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 47,077 ریال با حجم معاملات فراتر از میانگین ماهانه.
