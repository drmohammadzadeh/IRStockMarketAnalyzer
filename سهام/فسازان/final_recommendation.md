...
**آخرین قیمت معاملاتی:** 12,390 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.7** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (7.5/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (6.8/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.5** | افق کوتاه‌مدت (5.0/۱۰) + میان‌مدت (8.5/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.26 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **12,142 تا 12,638 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **12,710 ریال** | **+2.6%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **13,981 ریال** | **+12.8%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **11,151 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 12,710 ریال (بازدهی مورد انتظار: 2.6%)
- **حد ضرر:** 11,151 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 13,981 ریال (بازدهی مورد انتظار: 12.8%)
- **حد ضرر:** 10,816 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 17,476 ریال (بازدهی مورد انتظار: 41.1%)
- **حد ضرر:** 9,874 ریال (ریسک: 20.3%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 74.9 - ATR: 468 ریال | اشباع خرید / خنثی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 11,151 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/15 - 18:04`
