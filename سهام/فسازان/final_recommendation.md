...
**آخرین قیمت معاملاتی:** 12,750 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.6** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (6.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (6.8/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.3** | افق کوتاه‌مدت (4.2/۱۰) + میان‌مدت (7.7/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.01 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **12,495 تا 13,005 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **12,760 ریال** | **+0.1%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **14,036 ریال** | **+10.1%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **11,475 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 12,760 ریال (بازدهی مورد انتظار: 0.1%)
- **حد ضرر:** 11,475 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 14,036 ریال (بازدهی مورد انتظار: 10.1%)
- **حد ضرر:** 11,131 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 17,545 ریال (بازدهی مورد انتظار: 37.6%)
- **حد ضرر:** 9,909 ریال (ریسک: 22.3%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 77.6 - ATR: 450 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.70 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 11,475 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 4,331 ریال.
...
- **تاریخ صدور گواهی:** `1405/06/15 - 19:08`
