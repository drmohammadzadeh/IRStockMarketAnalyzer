...
**آخرین قیمت معاملاتی:** 13,130 ریال  
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.3** | افق کوتاه‌مدت (4.2/۱۰) + میان‌مدت (7.7/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=1.20 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **12,867 تا 13,393 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **14,706 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **16,176 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **11,817 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 14,706 ریال (بازدهی مورد انتظار: 12.0%)
- **حد ضرر:** 11,817 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 16,176 ریال (بازدهی مورد انتظار: 23.2%)
- **حد ضرر:** 11,462 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 20,220 ریال (بازدهی مورد انتظار: 54.0%)
- **حد ضرر:** 10,177 ریال (ریسک: 22.5%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 80.0 - ATR: 455 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.61 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 11,817 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 4,366 ریال.
...
- **تاریخ صدور گواهی:** `1405/06/16 - 11:42`
