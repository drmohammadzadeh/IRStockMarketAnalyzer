...
**آخرین قیمت معاملاتی:** 12,340 ریال | **دامنه روز:** 11,710 تا 12,400 ریال  
**حجم معاملات آخرین روز:** 55,665,873 برگه سهم (میانگین ۲۰ روزه: 49,990,282)
...
- **سقف ماژور دوره (Swing High):** 12,400 ریال
- **کف ماژور دوره (Swing Low):** 4,080 ریال
- **دامنه نوسان واقعی (ATR 14):** 454 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 10,911 | +13.1% | حمایت پویا |
| **EMA 50** | 9,541 | +29.3% | حمایت میان‌مدت |
| **EMA 100** | 8,071 | +52.9% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,590 | +87.2% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 12,090 ریال
- **باند میانی (SMA 20):** 11,008 ریال
- **باند پایینی (Lower Band):** 9,927 ریال
- **عرض باند (Bandwidth):** 19.7% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 11,315 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 10,765 ریال
- **ابر کومو اسپن A (Senkou Span A):** 7,920 ریال
- **ابر کومو اسپن B (Senkou Span B):** 6,960 ریال
...
- **مکدی (MACD 12,26,9):** 717.86 | **خط سیگنال:** 673.01 | **هیستوگرام:** 44.84
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 4,080 و سقف 12,400 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 12,400 | -0.5% | سقف موج (Pivot High) |
| **0.236** | 10,436 | +18.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 9,222 | +33.8% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 8,240 | +49.8% | تراز میانی تعادلی (50.0%) |
| **0.618** | 7,258 | +70.0% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,860 | +110.6% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,080 | +202.5% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **10,436 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **12,400 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **1.19** (برتری خریداران حقیقی بر فروشندگان)
- **سرانه خرید حقیقی:** 84,756 سهم | **سرانه فروش حقیقی:** 71,255 سهم
- **حجم خرید حقیقی:** 53,396,209 سهم | **حجم خرید حقوقی:** 2,269,664 سهم
- **حجم فروش حقیقی:** 43,821,656 سهم | **حجم فروش حقوقی:** 11,844,217 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **12,340 ریال** در مقایسه با میانگین ۲۰ روزه (10,911 ریال) و میانگین ۵۰ روزه (9,541 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **80.1** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+44.84** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.19** (برتری خریداران حقیقی بر فروشندگان) با سرانه خرید **84,756 سهم** ثبت گردیده است.
