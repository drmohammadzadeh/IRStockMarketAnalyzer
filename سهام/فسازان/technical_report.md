...
**آخرین قیمت معاملاتی:** 12,390 ریال | **دامنه روز:** 11,790 تا 12,450 ریال  
**حجم معاملات آخرین روز:** 31,771,943 برگه سهم (میانگین ۲۰ روزه: 44,527,173)
...
- **دامنه نوسان واقعی (ATR 14):** 468 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 11,270 | +9.9% | حمایت پویا |
| **EMA 50** | 9,853 | +25.8% | حمایت میان‌مدت |
| **EMA 100** | 8,317 | +49.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,759 | +83.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 12,607 ریال
- **باند میانی (SMA 20):** 11,274 ریال
- **باند پایینی (Lower Band):** 9,941 ریال
- **عرض باند (Bandwidth):** 23.6% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 11,785 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 11,340 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,525 ریال
- **ابر کومو اسپن B (Senkou Span B):** 7,365 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **74.9** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 752.31 | **خط سیگنال:** 710.09 | **هیستوگرام:** 42.22
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 4,331 و سقف 12,710 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 12,710 | -2.5% | سقف موج (Pivot High) |
| **0.236** | 10,733 | +15.4% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 9,509 | +30.3% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 8,520 | +45.4% | تراز میانی تعادلی (50.0%) |
| **0.618** | 7,532 | +64.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 6,124 | +102.3% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,331 | +186.1% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **10,733 ریال**
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **12,390 ریال** در مقایسه با میانگین ۲۰ روزه (11,270 ریال) و میانگین ۵۰ روزه (9,853 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **74.9** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+42.22** نوسان می‌کند.
