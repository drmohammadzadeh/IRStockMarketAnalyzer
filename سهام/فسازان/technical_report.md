...
**آخرین قیمت معاملاتی:** 12,750 ریال | **دامنه روز:** 12,510 تا 12,760 ریال  
**حجم معاملات آخرین روز:** 26,952,884 برگه سهم (میانگین ۲۰ روزه: 43,892,953)
...
- **سقف ماژور دوره (Swing High):** 12,760 ریال
- **کف ماژور دوره (Swing Low):** 4,331 ریال
- **دامنه نوسان واقعی (ATR 14):** 450 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 11,411 | +11.7% | حمایت پویا |
| **EMA 50** | 9,966 | +27.9% | حمایت میان‌مدت |
| **EMA 100** | 8,404 | +51.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,818 | +87.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 12,840 ریال
- **باند میانی (SMA 20):** 11,364 ریال
- **باند پایینی (Lower Band):** 9,888 ریال
- **عرض باند (Bandwidth):** 26.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 11,810 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 11,495 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,670 ریال
- **ابر کومو اسپن B (Senkou Span B):** 7,510 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **77.6** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 779.66 | **خط سیگنال:** 724.01 | **هیستوگرام:** 55.65
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 4,331 و سقف 12,760 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 12,760 | -0.1% | سقف موج (Pivot High) |
| **0.236** | 10,771 | +18.4% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 9,540 | +33.6% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 8,546 | +49.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 7,551 | +68.9% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 6,135 | +107.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,331 | +194.4% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **10,771 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **12,760 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.70** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 50,058 سهم | **سرانه فروش حقیقی:** 71,655 سهم
- **حجم خرید حقیقی:** 25,429,586 سهم | **حجم خرید حقوقی:** 6,342,357 سهم
- **حجم فروش حقیقی:** 27,443,737 سهم | **حجم فروش حقوقی:** 4,328,206 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **12,750 ریال** در مقایسه با میانگین ۲۰ روزه (11,411 ریال) و میانگین ۵۰ روزه (9,966 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **77.6** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+55.65** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.70** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **50,058 سهم** ثبت گردیده است.
