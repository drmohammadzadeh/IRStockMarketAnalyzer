...
**آخرین قیمت معاملاتی:** 13,130 ریال | **دامنه روز:** 13,020 تا 13,130 ریال  
**حجم معاملات آخرین روز:** 19,513,659 برگه سهم (میانگین ۲۰ روزه: 42,911,177)
...
- **سقف ماژور دوره (Swing High):** 13,130 ریال
- **کف ماژور دوره (Swing Low):** 4,366 ریال
- **دامنه نوسان واقعی (ATR 14):** 455 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 11,575 | +13.4% | حمایت پویا |
| **EMA 50** | 10,090 | +30.1% | حمایت میان‌مدت |
| **EMA 100** | 8,498 | +54.5% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,881 | +90.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 13,130 ریال
- **باند میانی (SMA 20):** 11,457 ریال
- **باند پایینی (Lower Band):** 9,784 ریال
- **عرض باند (Bandwidth):** 29.2% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 12,130 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 11,680 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,918 ریال
- **ابر کومو اسپن B (Senkou Span B):** 7,655 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **80.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 822.51 | **خط سیگنال:** 743.71 | **هیستوگرام:** 78.80
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 4,366 و سقف 13,130 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 13,130 | +0.0% | سقف موج (Pivot High) |
| **0.236** | 11,062 | +18.7% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 9,782 | +34.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 8,748 | +50.1% | تراز میانی تعادلی (50.0%) |
| **0.618** | 7,714 | +70.2% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 6,242 | +110.4% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,366 | +200.7% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **11,062 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **13,130 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.61** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 64,790 سهم | **سرانه فروش حقیقی:** 106,178 سهم
- **حجم خرید حقیقی:** 23,842,884 سهم | **حجم خرید حقوقی:** 3,110,000 سهم
- **حجم فروش حقیقی:** 24,845,753 سهم | **حجم فروش حقوقی:** 2,107,131 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **13,130 ریال** در مقایسه با میانگین ۲۰ روزه (11,575 ریال) و میانگین ۵۰ روزه (10,090 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **80.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+78.80** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.61** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **64,790 سهم** ثبت گردیده است.
