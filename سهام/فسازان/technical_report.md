...
**آخرین قیمت معاملاتی:** 12,180 ریال | **دامنه روز:** 12,100 تا 12,500 ریال  
**حجم معاملات آخرین روز:** 1,250,000 برگه سهم (میانگین ۲۰ روزه: 43,974,714)
...
- **سقف ماژور دوره (Swing High):** 12,500 ریال
- **کف ماژور دوره (Swing Low):** 4,110 ریال
- **دامنه نوسان واقعی (ATR 14):** 440 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 11,032 | +10.4% | حمایت پویا |
| **EMA 50** | 9,645 | +26.3% | حمایت میان‌مدت |
| **EMA 100** | 8,152 | +49.4% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,646 | +83.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 12,270 ریال
- **باند میانی (SMA 20):** 11,088 ریال
- **باند پایینی (Lower Band):** 9,905 ریال
- **عرض باند (Bandwidth):** 21.3% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 11,365 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 10,950 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,095 ریال
- **ابر کومو اسپن B (Senkou Span B):** 7,090 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **76.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 732.79 | **خط سیگنال:** 684.97 | **هیستوگرام:** 47.82
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 4,110 و سقف 12,500 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 12,500 | -2.6% | سقف موج (Pivot High) |
| **0.236** | 10,520 | +15.8% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 9,295 | +31.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 8,305 | +46.7% | تراز میانی تعادلی (50.0%) |
| **0.618** | 7,315 | +66.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,905 | +106.2% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,110 | +196.4% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **10,520 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **12,500 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **1.03** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 5,938 سهم | **سرانه فروش حقیقی:** 5,789 سهم
- **حجم خرید حقیقی:** 950,000 سهم | **حجم خرید حقوقی:** 300,000 سهم
- **حجم فروش حقیقی:** 1,100,000 سهم | **حجم فروش حقوقی:** 150,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **12,180 ریال** در مقایسه با میانگین ۲۰ روزه (11,032 ریال) و میانگین ۵۰ روزه (9,645 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **76.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+47.82** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.03** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **5,938 سهم** ثبت گردیده است.
