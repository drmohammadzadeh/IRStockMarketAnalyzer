...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **9,672,000 میلیون ریال** (معادل **967.2 میلیارد تومان** / 9,672,000,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **2,611,440 میلیون ریال** (معادل **261.1 میلیارد تومان** / 2,611,440,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **1,860,000 میلیون ریال** (معادل **186.0 میلیارد تومان** / 1,860,000,000,000 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
