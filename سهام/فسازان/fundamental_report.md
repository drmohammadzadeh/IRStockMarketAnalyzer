...
**آخرین قیمت:** 12,180 ریال | **ارزش بازار:** **8.53 همت** (85,260,000,000,000 ریال)  
...
نماد **فسازان** یکی از بازیگران اثرگذار در حوزه فعالیت خود در بازار بورس/فرابورس ایران است. بررسی زنجیره ارزش، سهم بازار داخلی و دسترسی به بازارهای صادراتی نشان‌دهنده توانمندی عملیاتی پایدار شرکت است.
...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **111,021,462 میلیون ریال** (معادل **11.10 همت** / 111,021,462,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **29,975,795 میلیون ریال** (معادل **3.00 همت** / 29,975,794,740,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **1,840 میلیون ریال** (معادل 1,840,000,000 ریال) | سود خالص با حاشیه 0.0% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **مجموع دارایی‌ها (Total Assets):** **53,159,963 میلیون ریال** (معادل **5.32 همت** / 53,159,963,000,000 ریال)
- **تسهیلات اعطایی و مطالبات (Loans):** **7,535,407 میلیون ریال** (معادل **753.5 میلیارد تومان** / 7,535,407,000,000 ریال)
- **سرمایه ثبت‌شده (Capital):** **7,000,000 میلیون ریال** (معادل **700.0 میلیارد تومان** / 7,000,000,000,000 ریال)
- **سود (زیان) انباشته (Retained Earnings):** **14,598,174 میلیون ریال** (معادل **1.46 همت** / 14,598,174,000,000 ریال)
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **53,159,963 میلیون ریال** (معادل **5.32 همت** / 53,159,963,000,000 ریال)
...
| **نسبت قیمت به فروش (P/S)** | **0.77** | 1.2 - 2.0 | بسیار مطلوب |
| **نسبت قیمت به ارزش دفتری (P/B)** | **1.60** | 2.5 - 4.0 | متناسب با بازده حقوق صاحبان سهام (ROE) |
...
- **جمع‌بندی نهایی:** نماد **فسازان** با اتکا به نسبت P/E جذاب (35.00)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (0.0%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
