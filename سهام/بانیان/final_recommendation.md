...
**امتیاز اجماع توصیه معاملاتی:** **4.1 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)**  
**آخرین قیمت معاملاتی:** 17,240 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.9** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (9.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (5.5/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **4.5** | افق کوتاه‌مدت (5.8/۱۰) + میان‌مدت (9.2/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=8.22 |
| **🌟 امتیاز نهایی اجماع (Composite Score)** | **4.1 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **16,895 تا 17,585 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **22,150 ریال** | **+28.5%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **24,365 ریال** | **+41.3%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **16,643 ریال** | **-3.5%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **8.22** | — | 🟢 جذاب (R/R >= 2) |
...
- **تارگت هدف:** 22,150 ریال (بازدهی مورد انتظار: 28.5%)
- **حد ضرر:** 16,643 ریال (حداکثر ریسک: 3.5%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 24,365 ریال (بازدهی مورد انتظار: 41.3%)
- **حد ضرر:** 16,143 ریال (ریسک: 6.4%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 30,456 ریال (بازدهی مورد انتظار: 76.7%)
- **حد ضرر:** 15,569 ریال (ریسک: 9.7%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 56.7 - ATR: 560 ریال | مساعد برای صعود |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.60 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 16,643 ریال با حجم معاملات فراتر از میانگین ماهانه.
