...
**آخرین قیمت معاملاتی:** 16,860 ریال | **دامنه روز:** 16,730 تا 17,130 ریال  
**حجم معاملات آخرین روز:** 10,405,652 برگه سهم (میانگین ۲۰ روزه: 9,268,237)
...
- **دامنه نوسان واقعی (ATR 14):** 565 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,932 | -0.4% | مقاومت نزدیک |
| **EMA 50** | 16,122 | +4.6% | حمایت میان‌مدت |
| **EMA 100** | 16,205 | +4.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 16,443 | +2.5% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 20,123 ریال
- **باند میانی (SMA 20):** 16,807 ریال
- **باند پایینی (Lower Band):** 13,491 ریال
- **عرض باند (Bandwidth):** 39.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,245 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,495 ریال
- **ابر کومو اسپن A (Senkou Span A):** 14,218 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **52.8** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 839.79 | **خط سیگنال:** 915.85 | **هیستوگرام:** -76.06
...
| :--- | :--- | :--- | :--- |
| **0.0** | 22,150 | -23.9% | سقف موج (Pivot High) |
| **0.236** | 16,923 | -0.4% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 13,689 | +23.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 11,075 | +52.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 8,461 | +99.3% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 4,740 | +255.7% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 0 | +1686000000000.0% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **13,689 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **16,923 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **3.34** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی))
- **سرانه خرید حقیقی:** 16,310 سهم | **سرانه فروش حقیقی:** 4,885 سهم
- **حجم خرید حقیقی:** 9,704,545 سهم | **حجم خرید حقوقی:** 701,107 سهم
- **حجم فروش حقیقی:** 9,863,652 سهم | **حجم فروش حقوقی:** 542,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **16,860 ریال** در مقایسه با میانگین ۲۰ روزه (16,932 ریال) و میانگین ۵۰ روزه (16,122 ریال) موقعیت **خنثی / رنج (نوسان در محدوده متراکم میانگین‌های متحرک)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **52.8** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-76.06** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **3.34** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی)) با سرانه خرید **16,310 سهم** ثبت گردیده است.
