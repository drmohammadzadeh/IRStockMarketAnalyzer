...
**تاریخ تحلیل:** 1405/06/14 - 10:49  
**آخرین قیمت معاملاتی:** 17,620 ریال | **دامنه روز:** 17,620 تا 17,620 ریال  
**حجم معاملات آخرین روز:** 1,043,449 برگه سهم (میانگین ۲۰ روزه: 8,960,983)
...
- **دامنه نوسان واقعی (ATR 14):** 542 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,908 | +4.2% | حمایت پویا |
| **EMA 50** | 16,045 | +9.8% | حمایت میان‌مدت |
| **EMA 100** | 16,170 | +9.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 16,431 | +7.2% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 20,180 ریال
- **باند میانی (SMA 20):** 16,531 ریال
- **باند پایینی (Lower Band):** 12,882 ریال
- **عرض باند (Bandwidth):** 44.2% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,515 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **60.9** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 1078.60 | **خط سیگنال:** 926.61 | **هیستوگرام:** 151.99
...
| :--- | :--- | :--- | :--- |
| **0.0** | 22,150 | -20.5% | سقف موج (Pivot High) |
| **0.236** | 16,923 | +4.1% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 13,689 | +28.7% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 11,075 | +59.1% | تراز میانی تعادلی (50.0%) |
| **0.618** | 8,461 | +108.2% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 4,740 | +271.7% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 0 | +1762000000000.0% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.03** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 2,526 سهم | **سرانه فروش حقیقی:** 80,265 سهم
- **حجم خرید حقیقی:** 232,393 سهم | **حجم خرید حقوقی:** 811,056 سهم
- **حجم فروش حقیقی:** 1,043,449 سهم | **حجم فروش حقوقی:** 0 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,620 ریال** در مقایسه با میانگین ۲۰ روزه (16,908 ریال) و میانگین ۵۰ روزه (16,045 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **60.9** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+151.99** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.03** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **2,526 سهم** ثبت گردیده است.
