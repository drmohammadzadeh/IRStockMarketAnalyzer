...
**آخرین قیمت معاملاتی:** 18,450 ریال | **دامنه روز:** 18,300 تا 18,700 ریال  
**حجم معاملات آخرین روز:** 850,000 برگه سهم (میانگین ۲۰ روزه: 8,805,603)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,861 | +9.4% | حمایت پویا |
| **EMA 50** | 15,992 | +15.4% | حمایت میان‌مدت |
| **EMA 100** | 16,147 | +14.3% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 16,422 | +12.4% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 20,201 ریال
- **باند میانی (SMA 20):** 16,350 ریال
- **باند پایینی (Lower Band):** 12,498 ریال
- **عرض باند (Bandwidth):** 47.1% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,265 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,420 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **71.3** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 1188.67 | **خط سیگنال:** 893.24 | **هیستوگرام:** 295.43
...
| :--- | :--- | :--- | :--- |
| **0.0** | 22,150 | -16.7% | سقف موج (Pivot High) |
| **0.236** | 16,923 | +9.0% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 13,689 | +34.8% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 11,075 | +66.6% | تراز میانی تعادلی (50.0%) |
| **0.618** | 8,461 | +118.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 4,740 | +289.2% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 0 | +1845000000000.0% | کف موج (Pivot Low) |
...
- **سرانه خرید حقیقی:** 5,167 سهم | **سرانه فروش حقیقی:** 5,000 سهم
- **حجم خرید حقیقی:** 620,000 سهم | **حجم خرید حقوقی:** 230,000 سهم
- **حجم فروش حقیقی:** 700,000 سهم | **حجم فروش حقوقی:** 150,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **18,450 ریال** در مقایسه با میانگین ۲۰ روزه (16,861 ریال) و میانگین ۵۰ روزه (15,992 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **71.3** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+295.43** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.03** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **5,167 سهم** ثبت گردیده است.
