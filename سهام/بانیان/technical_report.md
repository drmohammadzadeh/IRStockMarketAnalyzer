...
**آخرین قیمت معاملاتی:** 17,240 ریال | **دامنه روز:** 17,100 تا 17,780 ریال  
**حجم معاملات آخرین روز:** 4,302,828 برگه سهم (میانگین ۲۰ روزه: 9,008,148)
...
- **دامنه نوسان واقعی (ATR 14):** 560 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,940 | +1.8% | حمایت پویا |
| **EMA 50** | 16,092 | +7.1% | حمایت میان‌مدت |
| **EMA 100** | 16,191 | +6.5% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 16,439 | +4.9% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 20,163 ریال
- **باند میانی (SMA 20):** 16,688 ریال
- **باند پایینی (Lower Band):** 13,213 ریال
- **عرض باند (Bandwidth):** 41.6% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,430 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,495 ریال
- **ابر کومو اسپن A (Senkou Span A):** 14,190 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **56.7** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 967.88 | **خط سیگنال:** 934.86 | **هیستوگرام:** 33.01
...
| :--- | :--- | :--- | :--- |
| **0.0** | 22,150 | -22.2% | سقف موج (Pivot High) |
| **0.236** | 16,923 | +1.9% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 13,689 | +25.9% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 11,075 | +55.7% | تراز میانی تعادلی (50.0%) |
| **0.618** | 8,461 | +103.8% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 4,740 | +263.7% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 0 | +1724000000000.0% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,240 ریال** در مقایسه با میانگین ۲۰ روزه (16,940 ریال) و میانگین ۵۰ روزه (16,092 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **56.7** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+33.01** نوسان می‌کند.
