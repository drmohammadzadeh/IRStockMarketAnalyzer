...
**آخرین قیمت:** 18,590 ریال | **ارزش بازار:** **1.91 همت** (19,117,193,810,000 ریال)  
...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **809,804 میلیون ریال** (معادل **81.0 میلیارد تومان** / 809,804,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **218,647 میلیون ریال** (معادل **21.9 میلیارد تومان** / 218,647,080,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **196 میلیون ریال** (معادل 196,000,000 ریال) | سود خالص با حاشیه 0.0% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **مجموع دارایی‌ها (Total Assets):** **6,472,227 میلیون ریال** (معادل **647.2 میلیارد تومان** / 6,472,227,000,000 ریال)
- **تسهیلات اعطایی و مطالبات (Loans):** **1,318,844 میلیون ریال** (معادل **131.9 میلیارد تومان** / 1,318,844,000,000 ریال)
- **سرمایه ثبت‌شده (Capital):** **1,028,359 میلیون ریال** (معادل **102.8 میلیارد تومان** / 1,028,359,000,000 ریال)
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **6,472,227 میلیون ریال** (معادل **647.2 میلیارد تومان** / 6,472,227,000,000 ریال)
...
| **نسبت P/E فوروارد (تخمینی)** | **35.00** | 5.5 - 7.0 | جذاب برای سرمایه‌گذاری میان‌مدت |
| **نسبت قیمت به فروش (P/S)** | **23.61** | 1.2 - 2.0 | منصفانه |
| **نسبت قیمت به ارزش دفتری (P/B)** | **2.95** | 2.5 - 4.0 | متناسب با بازده حقوق صاحبان سهام (ROE) |
...
- **جمع‌بندی نهایی:** نماد **بانیان** با اتکا به نسبت P/E جذاب (35.00)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (0.0%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
