...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **167,479,456 میلیون ریال** (معادل **16.75 همت** / 167,479,456,171,200 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **45,219,453 میلیون ریال** (معادل **4.52 همت** / 45,219,453,166,224 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **32,207,588 میلیون ریال** (معادل **3.22 همت** / 32,207,587,725,231 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **سرمایه ثبت‌شده (Capital):** **301,656,081 میلیون ریال** (معادل **30.17 همت** / 301,656,081,000,000 ریال)
