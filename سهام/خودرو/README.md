...
| **آخرین قیمت معامله** | **706 ریال** | ثبت نوسانات پایان بازار 1405/06/14 |
| **محدوده خرید بهینه** | **692 تا 720 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **736 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **810 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **655 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.59** | 🔴 نیازمند احتیاط (R/R < 1.5) |
