...
**آخرین قیمت معاملاتی:** 743 ریال | **دامنه روز:** 742 تا 743 ریال  
**حجم معاملات آخرین روز:** 1,385,235,201 برگه سهم (میانگین ۲۰ روزه: 9,726,423,738)
...
- **سقف ماژور دوره (Swing High):** 743 ریال
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 670 | +10.9% | حمایت پویا |
| **EMA 50** | 616 | +20.6% | حمایت میان‌مدت |
| **EMA 100** | 613 | +21.2% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 824 | -9.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 773 ریال
- **باند میانی (SMA 20):** 662 ریال
- **باند پایینی (Lower Band):** 552 ریال
- **عرض باند (Bandwidth):** 33.4% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 709 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 630 ریال
- **ابر کومو اسپن A (Senkou Span A):** 532 ریال
- **ابر کومو اسپن B (Senkou Span B):** 522 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **74.8** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 42.30 | **خط سیگنال:** 38.42 | **هیستوگرام:** 3.88
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 446 و سقف 743 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 743 | +0.0% | سقف موج (Pivot High) |
| **0.236** | 673 | +10.4% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 630 | +18.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 594 | +25.0% | تراز میانی تعادلی (50.0%) |
| **0.618** | 559 | +32.8% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 510 | +45.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 446 | +66.6% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **673 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **743 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **1.08** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 2,035,375 سهم | **سرانه فروش حقیقی:** 1,892,443 سهم
- **حجم خرید حقیقی:** 7,095,316,500 سهم | **حجم خرید حقوقی:** 1,773,003,987 سهم
- **حجم فروش حقیقی:** 7,836,604,516 سهم | **حجم فروش حقوقی:** 1,031,715,971 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **743 ریال** در مقایسه با میانگین ۲۰ روزه (670 ریال) و میانگین ۵۰ روزه (616 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **74.8** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+3.88** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.08** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **2,035,375 سهم** ثبت گردیده است.
