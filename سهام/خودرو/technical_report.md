...
**آخرین قیمت معاملاتی:** 695 ریال | **دامنه روز:** 692 تا 725 ریال  
**حجم معاملات آخرین روز:** 320,000,000 برگه سهم (میانگین ۲۰ روزه: 8,274,985,833)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 645 | +7.8% | حمایت پویا |
| **EMA 50** | 598 | +16.3% | حمایت میان‌مدت |
| **EMA 100** | 604 | +15.1% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 828 | -16.1% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 744 ریال
- **باند میانی (SMA 20):** 633 ریال
- **باند پایینی (Lower Band):** 522 ریال
- **عرض باند (Bandwidth):** 35.1% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 674 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 622 ریال
- **ابر کومو اسپن A (Senkou Span A):** 543 ریال
- **ابر کومو اسپن B (Senkou Span B):** 531 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **68.0** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 41.81 | **خط سیگنال:** 33.76 | **هیستوگرام:** 8.05
...
| :--- | :--- | :--- | :--- |
| **0.0** | 736 | -5.6% | سقف موج (Pivot High) |
| **0.236** | 668 | +4.1% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 625 | +11.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 591 | +17.6% | تراز میانی تعادلی (50.0%) |
| **0.618** | 557 | +24.8% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 508 | +36.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 446 | +55.8% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **1.09** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 97,297 سهم | **سرانه فروش حقیقی:** 89,655 سهم
- **حجم خرید حقیقی:** 180,000,000 سهم | **حجم خرید حقوقی:** 140,000,000 سهم
- **حجم فروش حقیقی:** 260,000,000 سهم | **حجم فروش حقوقی:** 60,000,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **695 ریال** در مقایسه با میانگین ۲۰ روزه (645 ریال) و میانگین ۵۰ روزه (598 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **68.0** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+8.05** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.09** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **97,297 سهم** ثبت گردیده است.
