...
**تاریخ تحلیل:** 1405/06/14 - 10:41  
**آخرین قیمت معاملاتی:** 694 ریال | **دامنه روز:** 691 تا 711 ریال  
**حجم معاملات آخرین روز:** 12,838,829,828 برگه سهم (میانگین ۲۰ روزه: 9,264,500,684)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 651 | +6.7% | حمایت پویا |
| **EMA 50** | 602 | +15.3% | حمایت میان‌مدت |
| **EMA 100** | 606 | +14.5% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 827 | -16.1% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 750 ریال
- **باند میانی (SMA 20):** 641 ریال
- **باند پایینی (Lower Band):** 532 ریال
- **عرض باند (Bandwidth):** 34.1% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 690 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 626 ریال
- **ابر کومو اسپن A (Senkou Span A):** 540 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **67.2** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 41.54 | **خط سیگنال:** 35.53 | **هیستوگرام:** 6.01
...
| :--- | :--- | :--- | :--- |
| **0.0** | 736 | -5.7% | سقف موج (Pivot High) |
| **0.236** | 668 | +4.0% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 625 | +11.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 591 | +17.4% | تراز میانی تعادلی (50.0%) |
| **0.618** | 557 | +24.6% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 508 | +36.6% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 446 | +55.6% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.64** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 1,353,486 سهم | **سرانه فروش حقیقی:** 2,105,350 سهم
- **حجم خرید حقیقی:** 8,273,861,117 سهم | **حجم خرید حقوقی:** 4,564,968,711 سهم
- **حجم فروش حقیقی:** 10,956,243,781 سهم | **حجم فروش حقوقی:** 1,882,586,047 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **694 ریال** در مقایسه با میانگین ۲۰ روزه (651 ریال) و میانگین ۵۰ روزه (602 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **67.2** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+6.01** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.64** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **1,353,486 سهم** ثبت گردیده است.
