...
**آخرین قیمت معاملاتی:** 722 ریال | **دامنه روز:** 695 تا 727 ریال  
**حجم معاملات آخرین روز:** 8,868,320,487 برگه سهم (میانگین ۲۰ روزه: 9,822,224,615)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 662 | +9.0% | حمایت پویا |
| **EMA 50** | 611 | +18.2% | حمایت میان‌مدت |
| **EMA 100** | 610 | +18.3% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 825 | -12.5% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 762 ریال
- **باند میانی (SMA 20):** 655 ریال
- **باند پایینی (Lower Band):** 548 ریال
- **عرض باند (Bandwidth):** 32.7% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 701 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 626 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **71.9** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 40.94 | **خط سیگنال:** 37.45 | **هیستوگرام:** 3.49
...
| :--- | :--- | :--- | :--- |
| **0.0** | 736 | -1.9% | سقف موج (Pivot High) |
| **0.236** | 668 | +8.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 625 | +15.5% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 591 | +22.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 557 | +29.7% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 508 | +42.1% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 446 | +61.9% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **722 ریال** در مقایسه با میانگین ۲۰ روزه (662 ریال) و میانگین ۵۰ روزه (611 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **71.9** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+3.49** نوسان می‌کند.
