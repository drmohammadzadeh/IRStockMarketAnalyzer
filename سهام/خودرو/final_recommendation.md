...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.6** | افق کوتاه‌مدت (5.2/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=1.10 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **680 تا 708 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **736 ریال** | **+6.1%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **810 ریال** | **+16.7%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **656 ریال** | **-5.5%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.1** | — | 🔴 نامناسب (R/R < 1.5) |
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 67.2 - ATR: 24 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.64 | تعادل یا برتری عرضه |
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد خودرو

- **نماد تحت ممیزی:** `خودرو`
- **تاریخ صدور گواهی:** `1405/06/14 - 10:42`
