...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **7,704,000 میلیون ریال** (معادل **770.4 میلیارد تومان** / 7,704,000,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **2,080,080 میلیون ریال** (معادل **208.0 میلیارد تومان** / 2,080,080,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **1,481,538 میلیون ریال** (معادل **148.2 میلیارد تومان** / 1,481,538,461,538 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **3,439,286 میلیون ریال** (معادل **343.9 میلیارد تومان** / 3,439,285,714,286 ریال)
...
| **نسبت P/E فوروارد (تخمینی)** | **6.11** | 5.5 - 7.0 | جذاب برای سرمایه‌گذاری میان‌مدت |
...
| **سود هر سهم دوره اخیر (EPS ttm)** | **1,482 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **1,577 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,037 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
...
- **جمع‌بندی نهایی:** نماد **تلیسه** با اتکا به نسبت P/E جذاب (6.50)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (10.8%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
