# خلاصه اجرایی و جمع‌بندی تحلیلی نماد تلیسه

> **📅 تاریخ و ساعت آخرین پایش:** 1405/06/16 - 09:08  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
> **سیگنال و وضعیت تحلیلی:** خرید پله‌ای (Accumulate)  

نماد «تلیسه» (دامداری تلیسه نمونه) به عنوان یکی از مجموعه‌های فعال در گروه شرکت‌های زراعت و دامپروری، جایگاه مشخصی در بازار دارایی‌های مرتبط دارد. در آخرین تابلوی معاملاتی، قیمت پایانی با نوسان +1.9٪ به 9,650 ریال رسید و نسبت قدرت خریداران حقیقی در رقم 0.56 ثبت شد که نشان‌دهنده غلبه فشار عرضه و رفتار محتاطانه خریداران است. بررسی تراز عملیاتی، تنوع محصولات کشاورزی و دامی و ثبات در درآمدهای فصلی، چشم‌انداز بنیادی مطلوبی ترسیم کرده و ساختار نموداری نیز در سطوح حمایتی تثبیت شده است. برآیند ارزیابی‌های تحلیلی، سیگنال راهبردی سهم را در وضعیت «خرید پله‌ای (Accumulate)» ترسیم می‌کند با محدوده ورود بهینه 9,457 تا 9,843 ریال، تارگت اولیه 10,360 ریال، حد ضرر حمایتی 8,714 ریال و پایبندی به اصول انضباط معاملاتی به سهامداران توصیه می‌گردد.
