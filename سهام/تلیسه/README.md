...
> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/16 - 09:31  
...
| **آخرین قیمت معامله** | **9,650 ریال** | ثبت نوسانات پایان بازار 1405/06/16 |
| **محدوده خرید بهینه** | **9,457 تا 9,843 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **10,360 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **11,396 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **8,714 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.76** | 🔴 نیازمند احتیاط (R/R < 1.5) |
