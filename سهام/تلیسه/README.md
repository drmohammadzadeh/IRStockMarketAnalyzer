...
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «تلیسه»**  
...
| :--- | :--- |
| **نماد معاملاتی** | **تلیسه** |
| **نام شرکت / دارایی** | دامداری تلیسه نمونه |
| **بازار معاملاتی** | بورس / فرابورس اوراق بهادار تهران |
| **سابقه معاملاتی** | **2,224 روز معاملاتی** در سامانه TSETMC |
| **وضعیت تابلو و صف** | نوسان منفی همگام با شاخص کل |
...
| **آخرین قیمت معامله** | **9,920 ریال** | ثبت نوسانات پایان بازار ۱۴۰۵/۰۶/۱۰ |
| **محدوده خرید بهینه** | **9,722 تا 10,118 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **10,250 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **11,275 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **8,928 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.33** | 🔴 نیازمند احتیاط (R/R < 1.5) |
| **قدرت خریدار حقیقی** | **0.99** | تعادل خریدار و فروشنده |
...
- **تاریخ صدور گواهی:** `1405/06/11 - 19:30`
