...
> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/16 - 11:44  
...
| **آخرین قیمت معامله** | **9,680 ریال** | ثبت نوسانات پایان بازار 1405/06/16 |
| **محدوده خرید بهینه** | **9,486 تا 9,874 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **10,360 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **11,396 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **8,713 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.70** | 🔴 نیازمند احتیاط (R/R < 1.5) |
