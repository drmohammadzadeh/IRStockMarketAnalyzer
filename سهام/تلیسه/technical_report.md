...
**آخرین قیمت معاملاتی:** 9,470 ریال | **دامنه روز:** 9,380 تا 9,830 ریال  
**حجم معاملات آخرین روز:** 31,547,869 برگه سهم (میانگین ۲۰ روزه: 24,222,497)
...
- **دامنه نوسان واقعی (ATR 14):** 406 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 9,224 | +2.7% | حمایت پویا |
| **EMA 50** | 8,395 | +12.8% | حمایت میان‌مدت |
| **EMA 100** | 7,349 | +28.9% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,178 | +53.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 10,386 ریال
- **باند میانی (SMA 20):** 9,213 ریال
- **باند پایینی (Lower Band):** 8,040 ریال
- **عرض باند (Bandwidth):** 25.5% (سنجش میزان فشردگی نوسانات)
...
- **ابر کومو اسپن A (Senkou Span A):** 8,268 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **58.4** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 431.08 | **خط سیگنال:** 438.61 | **هیستوگرام:** -7.54
...
| :--- | :--- | :--- | :--- |
| **0.0** | 10,360 | -8.6% | سقف موج (Pivot High) |
| **0.236** | 8,916 | +6.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 8,023 | +18.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 7,301 | +29.7% | تراز میانی تعادلی (50.0%) |
| **0.618** | 6,579 | +43.9% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,551 | +70.6% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,242 | +123.2% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **9,470 ریال** در مقایسه با میانگین ۲۰ روزه (9,224 ریال) و میانگین ۵۰ روزه (8,395 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **58.4** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-7.54** نوسان می‌کند.
