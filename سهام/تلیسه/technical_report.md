...
**آخرین قیمت معاملاتی:** 9,670 ریال | **دامنه روز:** 9,370 تا 9,910 ریال  
**حجم معاملات آخرین روز:** 29,321,768 برگه سهم (میانگین ۲۰ روزه: 23,315,179)
...
- **دامنه نوسان واقعی (ATR 14):** 393 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 9,198 | +5.1% | حمایت پویا |
| **EMA 50** | 8,351 | +15.8% | حمایت میان‌مدت |
| **EMA 100** | 7,306 | +32.4% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,145 | +57.4% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 10,469 ریال
- **باند میانی (SMA 20):** 9,125 ریال
- **باند پایینی (Lower Band):** 7,781 ریال
- **عرض باند (Bandwidth):** 29.4% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 9,630 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 8,710 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,335 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **62.8** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 466.36 | **خط سیگنال:** 440.50 | **هیستوگرام:** 25.87
...
| :--- | :--- | :--- | :--- |
| **0.0** | 10,360 | -6.7% | سقف موج (Pivot High) |
| **0.236** | 8,916 | +8.5% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 8,023 | +20.5% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 7,301 | +32.4% | تراز میانی تعادلی (50.0%) |
| **0.618** | 6,579 | +47.0% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,551 | +74.2% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,242 | +128.0% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.65** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 36,430 سهم | **سرانه فروش حقیقی:** 56,280 سهم
- **حجم خرید حقیقی:** 21,785,396 سهم | **حجم خرید حقوقی:** 7,536,372 سهم
- **حجم فروش حقیقی:** 29,321,768 سهم | **حجم فروش حقوقی:** 0 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **9,670 ریال** در مقایسه با میانگین ۲۰ روزه (9,198 ریال) و میانگین ۵۰ روزه (8,351 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **62.8** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+25.87** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.65** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **36,430 سهم** ثبت گردیده است.
