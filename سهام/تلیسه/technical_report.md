...
**آخرین قیمت معاملاتی:** 9,650 ریال | **دامنه روز:** 9,530 تا 9,700 ریال  
**حجم معاملات آخرین روز:** 2,520,605 برگه سهم (میانگین ۲۰ روزه: 24,095,801)
...
- **دامنه نوسان واقعی (ATR 14):** 404 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 9,264 | +4.2% | حمایت پویا |
| **EMA 50** | 8,444 | +14.3% | حمایت میان‌مدت |
| **EMA 100** | 7,394 | +30.5% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,213 | +55.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 10,321 ریال
- **باند میانی (SMA 20):** 9,298 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **61.1** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 412.88 | **خط سیگنال:** 433.46 | **هیستوگرام:** -20.59
...
| :--- | :--- | :--- | :--- |
| **0.0** | 10,360 | -6.9% | سقف موج (Pivot High) |
| **0.236** | 8,916 | +8.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 8,023 | +20.3% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 7,301 | +32.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 6,579 | +46.7% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,551 | +73.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,242 | +127.5% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **9,650 ریال** در مقایسه با میانگین ۲۰ روزه (9,264 ریال) و میانگین ۵۰ روزه (8,444 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **61.1** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-20.59** نوسان می‌کند.
