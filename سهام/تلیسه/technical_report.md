...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **10,060 ریال** در مقایسه با میانگین ۲۰ روزه (9,011 ریال) و میانگین ۵۰ روزه (8,175 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **72.1** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+91.80** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.18** (برتری خریداران حقیقی بر فروشندگان) با سرانه خرید **75,348 سهم** ثبت گردیده است.
