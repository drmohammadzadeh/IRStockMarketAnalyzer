...
**آخرین قیمت معاملاتی:** 9,680 ریال | **دامنه روز:** 9,520 تا 9,750 ریال  
**حجم معاملات آخرین روز:** 37,805,282 برگه سهم (میانگین ۲۰ روزه: 25,860,035)
...
- **دامنه نوسان واقعی (ATR 14):** 407 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 9,267 | +4.5% | حمایت پویا |
| **EMA 50** | 8,445 | +14.6% | حمایت میان‌مدت |
| **EMA 100** | 7,395 | +30.9% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 6,213 | +55.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 10,324 ریال
- **باند میانی (SMA 20):** 9,300 ریال
- **باند پایینی (Lower Band):** 8,276 ریال
- **عرض باند (Bandwidth):** 22.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 9,630 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 8,715 ریال
- **ابر کومو اسپن A (Senkou Span A):** 8,222 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **61.5** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 415.27 | **خط سیگنال:** 433.94 | **هیستوگرام:** -18.67
...
| :--- | :--- | :--- | :--- |
| **0.0** | 10,360 | -6.6% | سقف موج (Pivot High) |
| **0.236** | 8,916 | +8.6% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 8,023 | +20.7% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 7,301 | +32.6% | تراز میانی تعادلی (50.0%) |
| **0.618** | 6,579 | +47.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 5,551 | +74.4% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 4,242 | +128.2% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.56** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 31,065 سهم | **سرانه فروش حقیقی:** 55,876 سهم
- **حجم خرید حقیقی:** 25,317,619 سهم | **حجم خرید حقوقی:** 6,230,250 سهم
- **حجم فروش حقیقی:** 29,055,351 سهم | **حجم فروش حقوقی:** 2,492,518 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **9,680 ریال** در مقایسه با میانگین ۲۰ روزه (9,267 ریال) و میانگین ۵۰ روزه (8,445 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **61.5** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-18.67** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.56** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **31,065 سهم** ثبت گردیده است.
