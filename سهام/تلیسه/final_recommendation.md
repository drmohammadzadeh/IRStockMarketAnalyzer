...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.8** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (6.2/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.6** | افق کوتاه‌مدت (5.2/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.81 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **9,437 تا 9,823 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **10,360 ریال** | **+7.6%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **11,396 ریال** | **+18.3%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **8,730 ریال** | **-9.3%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.81** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 10,360 ریال (بازدهی مورد انتظار: 7.6%)
- **حد ضرر:** 8,730 ریال (حداکثر ریسک: 9.3%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 11,396 ریال (بازدهی مورد انتظار: 18.3%)
- **حد ضرر:** 8,468 ریال (ریسک: 12.1%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 14,245 ریال (بازدهی مورد انتظار: 47.9%)
- **حد ضرر:** 8,203 ریال (ریسک: 14.8%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 62.3 - ATR: 372 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.18 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 8,730 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد تلیسه

- **نماد تحت ممیزی:** `تلیسه`
- **تاریخ صدور گواهی:** `1405/06/14 - 10:38`
