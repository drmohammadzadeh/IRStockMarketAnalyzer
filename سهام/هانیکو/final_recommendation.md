# جمع‌بندی تحلیلی و پیشنهاد معاملاتی نماد هانیکو
...
**آخرین قیمت معاملاتی:** 8,310 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.5** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (10.0/۱۰ با وزن ۲۵٪) + اخبار (6.0/۱۰ با وزن ۱۰٪) |
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **4.9** | افق کوتاه‌مدت (9.0/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=2.38 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **8,144 تا 8,476 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **8,735 ریال** | **+5.1%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **10,790 ریال** | **+29.8%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **8,131 ریال** | **-2.1%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **2.38** | — | 🟢 جذاب (R/R >= 2) |
...
- **تارگت هدف:** 8,735 ریال (بازدهی مورد انتظار: 5.1%)
- **حد ضرر:** 8,131 ریال (حداکثر ریسک: 2.1%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 10,790 ریال (بازدهی مورد انتظار: 29.8%)
- **حد ضرر:** 7,888 ریال (ریسک: 5.1%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 13,488 ریال (بازدهی مورد انتظار: 62.3%)
- **حد ضرر:** 7,590 ریال (ریسک: 8.7%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 64.6 - ATR: 237 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 4.60 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 8,131 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 6,680 ریال.
