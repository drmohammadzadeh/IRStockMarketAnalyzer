...
**آخرین قیمت معاملاتی:** 17,460 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.8** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (6.5/۱۰ با وزن ۳۰٪) + تابلوخوانی (4.5/۱۰ با وزن ۲۵٪) + اخبار (6.0/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.5** | افق کوتاه‌مدت (5.5/۱۰) + میان‌مدت (8.0/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=1.21 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **17,111 تا 17,809 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **19,180 ریال** | **+9.9%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **21,098 ریال** | **+20.8%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **16,033 ریال** | **-8.2%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.21** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 19,180 ریال (بازدهی مورد انتظار: 9.9%)
- **حد ضرر:** 16,033 ریال (حداکثر ریسک: 8.2%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 21,098 ریال (بازدهی مورد انتظار: 20.8%)
- **حد ضرر:** 15,552 ریال (ریسک: 10.9%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 26,372 ریال (بازدهی مورد انتظار: 51.0%)
- **حد ضرر:** 15,084 ریال (ریسک: 13.6%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 49.8 - ATR: 725 ریال | مساعد برای صعود |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 16,033 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/15 - 18:05`
