# گزارش تحلیلی جامع تکنیکال و تابلوخوانی نماد غمهرا

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/14 - 14:52  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
**تاریخ تحلیل:** 1405/06/14 - 14:52  
**آخرین قیمت معاملاتی:** 17,300 ریال | **دامنه روز:** 17,260 تا 18,000 ریال  
**حجم معاملات آخرین روز:** 3,855,258 برگه سهم (میانگین ۲۰ روزه: 7,248,623)

---

## ۱. تحلیل ساختار روند و امواج (Trend Structure & Wave Patterns)
- **وضعیت کلی روند:** 🟡 خنثی - خنثی / رنج (نوسان در محدوده متراکم میانگین‌های متحرک)
- **سقف ماژور دوره (Swing High):** 19,180 ریال
- **کف ماژور دوره (Swing Low):** 7,380 ریال
- **دامنه نوسان واقعی (ATR 14):** 755 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 17,699 | -2.3% | مقاومت نزدیک |
| **EMA 50** | 16,516 | +4.7% | حمایت میان‌مدت |
| **EMA 100** | 15,009 | +15.3% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,416 | +28.9% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,636 ریال
- **باند میانی (SMA 20):** 17,818 ریال
- **باند پایینی (Lower Band):** 17,000 ریال
- **عرض باند (Bandwidth):** 9.2% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,095 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 17,440 ریال
- **ابر کومو اسپن A (Senkou Span A):** 16,658 ریال
- **ابر کومو اسپن B (Senkou Span B):** 13,280 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **48.1** (تکانه ضعیف و حرکت در فاز رنج منفی)
- **مکدی (MACD 12,26,9):** 298.83 | **خط سیگنال:** 440.52 | **هیستوگرام:** -141.68
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 7,380 و سقف 19,180 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 19,180 | -9.8% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +5.5% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,672 | +17.9% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,280 | +30.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 11,888 | +45.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 9,905 | +74.7% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 7,380 | +134.4% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **16,395 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **19,180 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.25** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 8,426 سهم | **سرانه فروش حقیقی:** 33,268 سهم
- **حجم خرید حقیقی:** 1,651,468 سهم | **حجم خرید حقوقی:** 2,203,790 سهم
- **حجم فروش حقیقی:** 2,628,141 سهم | **حجم فروش حقوقی:** 1,227,117 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,300 ریال** در مقایسه با میانگین ۲۰ روزه (17,699 ریال) و میانگین ۵۰ روزه (16,516 ریال) موقعیت **خنثی / رنج (نوسان در محدوده متراکم میانگین‌های متحرک)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **48.1** (تکانه ضعیف و حرکت در فاز رنج منفی) است و هیستوگرام مکدی در وضعیت **-141.68** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.25** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **8,426 سهم** ثبت گردیده است.
