...
**آخرین قیمت معاملاتی:** 17,710 ریال | **دامنه روز:** 17,300 تا 17,980 ریال  
**حجم معاملات آخرین روز:** 5,531,310 برگه سهم (میانگین ۲۰ روزه: 6,495,290)
...
- **دامنه نوسان واقعی (ATR 14):** 737 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 17,679 | +0.2% | حمایت پویا |
| **EMA 50** | 16,598 | +6.7% | حمایت میان‌مدت |
| **EMA 100** | 15,110 | +17.2% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,499 | +31.2% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,624 ریال
- **باند میانی (SMA 20):** 17,817 ریال
- **باند پایینی (Lower Band):** 17,010 ریال
- **عرض باند (Bandwidth):** 9.1% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,985 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 17,440 ریال
- **ابر کومو اسپن A (Senkou Span A):** 16,830 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **52.5** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 225.99 | **خط سیگنال:** 366.87 | **هیستوگرام:** -140.88
...
| :--- | :--- | :--- | :--- |
| **0.0** | 19,180 | -7.7% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +8.0% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,672 | +20.7% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,280 | +33.4% | تراز میانی تعادلی (50.0%) |
| **0.618** | 11,888 | +49.0% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 9,905 | +78.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 7,380 | +140.0% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.59** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 23,411 سهم | **سرانه فروش حقیقی:** 39,370 سهم
- **حجم خرید حقیقی:** 5,431,310 سهم | **حجم خرید حقوقی:** 100,000 سهم
- **حجم فروش حقیقی:** 4,291,297 سهم | **حجم فروش حقوقی:** 1,240,013 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,710 ریال** در مقایسه با میانگین ۲۰ روزه (17,679 ریال) و میانگین ۵۰ روزه (16,598 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **52.5** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-140.88** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.59** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **23,411 سهم** ثبت گردیده است.
