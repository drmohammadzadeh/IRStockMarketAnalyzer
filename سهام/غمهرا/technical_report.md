...
**آخرین قیمت معاملاتی:** 17,460 ریال | **دامنه روز:** 17,200 تا 17,780 ریال  
**حجم معاملات آخرین روز:** 2,541,167 برگه سهم (میانگین ۲۰ روزه: 6,939,234)
...
- **دامنه نوسان واقعی (ATR 14):** 725 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 17,676 | -1.2% | مقاومت نزدیک |
| **EMA 50** | 16,553 | +5.5% | حمایت میان‌مدت |
| **EMA 100** | 15,058 | +16.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,457 | +29.7% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,629 ریال
- **باند میانی (SMA 20):** 17,824 ریال
- **باند پایینی (Lower Band):** 17,019 ریال
- **عرض باند (Bandwidth):** 9.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 18,065 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 17,440 ریال
- **ابر کومو اسپن A (Senkou Span A):** 16,742 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **49.8** (تکانه ضعیف و حرکت در فاز رنج منفی)
- **مکدی (MACD 12,26,9):** 248.40 | **خط سیگنال:** 402.09 | **هیستوگرام:** -153.70
...
| :--- | :--- | :--- | :--- |
| **0.0** | 19,180 | -9.0% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +6.5% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,672 | +19.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,280 | +31.5% | تراز میانی تعادلی (50.0%) |
| **0.618** | 11,888 | +46.9% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 9,905 | +76.3% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 7,380 | +136.6% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.89** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 14,689 سهم | **سرانه فروش حقیقی:** 16,486 سهم
- **حجم خرید حقیقی:** 2,541,167 سهم | **حجم خرید حقوقی:** 0 سهم
- **حجم فروش حقیقی:** 1,879,427 سهم | **حجم فروش حقوقی:** 661,740 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,460 ریال** در مقایسه با میانگین ۲۰ روزه (17,676 ریال) و میانگین ۵۰ روزه (16,553 ریال) موقعیت **خنثی / رنج (نوسان در محدوده متراکم میانگین‌های متحرک)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **49.8** (تکانه ضعیف و حرکت در فاز رنج منفی) است و هیستوگرام مکدی در وضعیت **-153.70** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.89** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **14,689 سهم** ثبت گردیده است.
