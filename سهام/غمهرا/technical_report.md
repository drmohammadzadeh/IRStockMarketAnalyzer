...
**آخرین قیمت معاملاتی:** 18,230 ریال | **دامنه روز:** 18,220 تا 18,240 ریال  
**حجم معاملات آخرین روز:** 696,791 برگه سهم (میانگین ۲۰ روزه: 5,485,142)
...
- **دامنه نوسان واقعی (ATR 14):** 738 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 17,732 | +2.8% | حمایت پویا |
| **EMA 50** | 16,662 | +9.4% | حمایت میان‌مدت |
| **EMA 100** | 15,172 | +20.2% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,546 | +34.6% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,597 ریال
- **باند میانی (SMA 20):** 17,810 ریال
- **باند پایینی (Lower Band):** 17,022 ریال
- **عرض باند (Bandwidth):** 8.8% (سنجش میزان فشردگی نوسانات)
...
- **ابر کومو اسپن A (Senkou Span A):** 16,890 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **57.5** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 247.34 | **خط سیگنال:** 342.97 | **هیستوگرام:** -95.62
...
| :--- | :--- | :--- | :--- |
| **0.0** | 19,180 | -5.0% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +11.2% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,672 | +24.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,280 | +37.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 11,888 | +53.4% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 9,905 | +84.0% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 7,380 | +147.0% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **18,230 ریال** در مقایسه با میانگین ۲۰ روزه (17,732 ریال) و میانگین ۵۰ روزه (16,662 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **57.5** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-95.62** نوسان می‌کند.
