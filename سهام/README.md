...
| :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| 1 | [**تابان**](تابان/README.md) | گروه پتروشیمی تابان فردا | **4.7** | **5.0** | **4.7** | **4.8 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)** | **10.0** | 🛡️ تأیید ممیزی | نسبت P/NAV حدود ۴۰٪، تخفیف ۶۰٪ در عرضه اولیه، حداقل بازدهی تضمین‌شده ۴۰٪ سالانه |
| 2 | [**زهلال**](زهلال/README.md) | کشت و صنعت و دامپروری صنایع غذایی هلال (کشت و صنعت هلال) | **4.6** | **5.0** | **4.0** | **4.5 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)** | **10.0** | 🛡️ تأیید ممیزی | رشد ۲۰۱٪ فروش ۵ ماهه (۶۴۵ میلیارد تومان)، مزایده موفق ۹۰ هکتار باغات پسته، سودآوری نقدی از فروش روزانه شیر خام در صنعت زراعت |
...
| 4 | [**کلید**](کلید/README.md) | صندوق املاک و مستغلات کلید | **4.0** | **4.0** | **3.7** | **3.9 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | پورتفوی املاک فیزیکی ۶۹۵ میلیارد تومانی، مازاد تجدید ارزیابی ۲۵۸ میلیارد تومانی، پوشش تورمی |
...
| 7 | [**فسازان**](فسازان/README.md) | غلتک‌سازان سپاهان | **3.8** | **4.0** | **3.5** | **3.8 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | رشد فروش شمش و قطعات چدنی، صادرات‌محور، ارزش بازاری مناسب نسبت به دارایی‌ها |
| 8 | [**غمهرا**](غمهرا/README.md) | گروه تولیدی مهرام | **3.6** | **4.0** | **3.4** | **3.7 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | برند پیشرو و باسابقه صنایع غذایی و سس‌ها، سلامت مالی بالا و حاشیه سود پایدار، رشد مستمر فروش ماهانه |
| 9 | [**وتجارت**](وتجارت/README.md) | بانک تجارت | **3.6** | **4.0** | **3.3** | **3.6 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | اصلاح قیمتی در صف فروش پایان بازار، بنیاد مطلوب بانکی، افت RSI به فاز تعادل، انتظار جمع‌آوری صف |
...
| **کلید** | صندوق املاک و مستغلات کلید | **🟢 خرید / ورود پله‌ای (Buy)** (3.9 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری کلید](کلید/README.md) |
...
| **فسازان** | غلتک‌سازان سپاهان | **🟢 خرید / ورود پله‌ای (Buy)** (3.8 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری فسازان](فسازان/README.md) |
| **غمهرا** | گروه تولیدی مهرام | **🟢 خرید / ورود پله‌ای (Buy)** (3.7 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری غمهرا](غمهرا/README.md) |
