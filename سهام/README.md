...
| 3 | [**خودرو**](خودرو/README.md) | ایران خودرو | **4.2** | **4.0** | **3.8** | **4.0 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | تراکم قیمت در محدوده میانگین‌ها، زیان انباشته تاریخی، مشروط به آزادسازی نرخ و تجدید ارزیابی |
| 4 | [**غمهرا**](غمهرا/README.md) | گروه تولیدی مهرام | **4.1** | **4.0** | **3.8** | **4.0 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | برند پیشرو و باسابقه صنایع غذایی و سس‌ها، سلامت مالی بالا و حاشیه سود پایدار، رشد مستمر فروش ماهانه |
| 5 | [**تلیسه**](تلیسه/README.md) | دامداری تلیسه نمونه | **3.9** | **4.0** | **3.7** | **3.9 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | سودآوری عملیاتی مطلوب، قیمت منصفانه، نوسان طبیعی در اصلاح مقطعی بازار |
...
| 7 | [**بانیان**](بانیان/README.md) | صندوق املاک و مستغلات بانیان مسکن | **3.6** | **4.0** | **3.4** | **3.7 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | دارایی‌های ملکی مرغوب، جریان درآمد اجاره باثبات، جذابیت تخفیف نسبت به ارزش روز املاک |
...
| 9 | [**فسازان**](فسازان/README.md) | غلتک‌سازان سپاهان | **3.6** | **4.0** | **3.3** | **3.6 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | رشد فروش شمش و قطعات چدنی، صادرات‌محور، ارزش بازاری مناسب نسبت به دارایی‌ها |
...
| **خودرو** | ایران خودرو | **🟢 خرید / ورود پله‌ای (Buy)** (4.0 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری خودرو](خودرو/README.md) |
| **غمهرا** | گروه تولیدی مهرام | **🟢 خرید / ورود پله‌ای (Buy)** (4.0 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری غمهرا](غمهرا/README.md) |
| **تلیسه** | دامداری تلیسه نمونه | **🟢 خرید / ورود پله‌ای (Buy)** (3.9 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری تلیسه](تلیسه/README.md) |
| **کلید** | صندوق املاک و مستغلات کلید | **🟢 خرید / ورود پله‌ای (Buy)** (3.8 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری کلید](کلید/README.md) |
| **بانیان** | صندوق املاک و مستغلات بانیان مسکن | **🟢 خرید / ورود پله‌ای (Buy)** (3.7 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری بانیان](بانیان/README.md) |
