...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **10,856,000 میلیون ریال** (معادل **1.09 همت** / 10,856,000,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **2,931,120 میلیون ریال** (معادل **293.1 میلیارد تومان** / 2,931,120,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **2,087,692 میلیون ریال** (معادل **208.8 میلیارد تومان** / 2,087,692,307,692 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **4,846,429 میلیون ریال** (معادل **484.6 میلیارد تومان** / 4,846,428,571,429 ریال)
...
| **سود هر سهم دوره اخیر (EPS ttm)** | **2,088 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **2,338 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,461 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
...
- **جمع‌بندی نهایی:** نماد **تابان** با اتکا به نسبت P/E جذاب (6.50)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (10.8%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
