...
| **آخرین قیمت معامله** | **13,970 ریال** | ثبت نوسانات پایان بازار 1405/06/14 |
| **محدوده خرید بهینه** | **13,691 تا 14,249 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **15,646 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **17,211 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **12,992 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.71** | 🟡 مناسب (R/R >= 1.5) |
