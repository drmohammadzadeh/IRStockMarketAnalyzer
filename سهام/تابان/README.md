...
> *تاریخ آخرین به‌روزرسانی بر مبنای آخرین معاملات بازار:* 1405/06/21 - 15:37  
...
| **سابقه معاملاتی** | **۹ روز معاملاتی** در سامانه TSETMC |
| **وضعیت تابلو و صف** | تقاضای پرقدرت با سرانه خرید استثنایی |
...
| **امتیاز هوش مصنوعی (Danelfin AI Score)** | **۸.۷ از ۱۰ (سطح ۹)** | 🟢 سیگنال خرید قوی (بنیادی: ۹.۵، تکنیکال: ۹.۰، سنتیمنت: ۸.۷، ریسک پایین: ۷.۲) |
| **آخرین قیمت معامله** | **16,170 ریال** | بازدهی روزانه: **+۲.۹۹٪** |
| **محدوده خرید بهینه** | **15,847 تا 16,493 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **18,110 ریال** | مقاومت اول و هدف نوسانی (+۱۲.۰٪) |
| **حد سود دوم (میان‌مدت)** | **19,921 ریال** | سقف کانال ماژور و مقاومت کلیدی (+۲۳.۲٪) |
| **حد ضرر پویا (Dynamic SL)** | **15,375 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR (-۴.۹٪) |
| **نسبت سود به ریسک (R/R)** | **2.44** | 🟢 جذاب (R/R >= 2.0) |
| **قدرت خریدار حقیقی** | **36.56** | برتری چشمگیر و ورود بسیار پرقدرت پول هوشمند |
