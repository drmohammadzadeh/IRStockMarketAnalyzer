...
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «تابان»**  
...
| :--- | :--- |
| **نماد معاملاتی** | **تابان** |
| **نام شرکت / دارایی** | گروه پتروشیمی تابان فردا |
| **بازار معاملاتی** | بورس / فرابورس اوراق بهادار تهران |
| **سابقه معاملاتی** | **2 روز معاملاتی** در سامانه TSETMC |
| **وضعیت تابلو و صف** | تقاضای پایدار در عرضه اولیه |
...
| **آخرین قیمت معامله** | **12,800 ریال** | ثبت نوسانات پایان بازار ۱۴۰۵/۰۶/۱۰ |
| **محدوده خرید بهینه** | **12,544 تا 13,056 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **14,336 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **15,770 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **11,904 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.71** | 🟡 قابل قبول (R/R >= 1.5) |
| **قدرت خریدار حقیقی** | **1.29** | برتری خریداران و ورود پول هوشمند |
...
## 📂 ساختار گزارش‌ها و فایل‌های استخراج‌شده نماد تابان
...
- **تاریخ صدور گواهی:** `1405/06/11 - 19:21`
