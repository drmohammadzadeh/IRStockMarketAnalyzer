...
**آخرین قیمت معاملاتی:** 14,810 ریال  
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **5.0** | افق کوتاه‌مدت (9.5/۱۰) + میان‌مدت (9.2/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=3.75 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **14,514 تا 15,106 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **16,587 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **18,246 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **14,336 ریال** | **-3.2%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **3.75** | — | 🟢 جذاب (R/R >= 2) |
...
- **تارگت هدف:** 16,587 ریال (بازدهی مورد انتظار: 12.0%)
- **حد ضرر:** 14,336 ریال (حداکثر ریسک: 3.2%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 18,246 ریال (بازدهی مورد انتظار: 23.2%)
- **حد ضرر:** 13,906 ریال (ریسک: 6.1%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 22,807 ریال (بازدهی مورد انتظار: 54.0%)
- **حد ضرر:** 13,189 ریال (ریسک: 10.9%)
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 14,336 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/16 - 11:39`
