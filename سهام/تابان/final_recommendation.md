...
**آخرین قیمت معاملاتی:** 13,970 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.6** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (9.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (10.0/۱۰ با وزن ۲۵٪) + اخبار (5.5/۱۰ با وزن ۱۰٪) |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **13,691 تا 14,249 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **15,646 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **17,211 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **12,992 ریال** | **-7.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 35.63 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 12,992 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/15 - 17:59`
