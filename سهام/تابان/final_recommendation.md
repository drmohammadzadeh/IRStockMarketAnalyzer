...
**آخرین قیمت معاملاتی:** 16,170 ریال  
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **5.0** | افق کوتاه‌مدت (9.5/۱۰) + میان‌مدت (9.2/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=2.44 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **15,847 تا 16,493 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **18,110 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **19,921 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **15,375 ریال** | **-4.9%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **2.44** | — | 🟢 جذاب (R/R >= 2) |
...
- **تارگت هدف:** 18,110 ریال (بازدهی مورد انتظار: 12.0%)
- **حد ضرر:** 15,375 ریال (حداکثر ریسک: 4.9%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 19,921 ریال (بازدهی مورد انتظار: 23.2%)
- **حد ضرر:** 14,913 ریال (ریسک: 7.8%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 24,902 ریال (بازدهی مورد انتظار: 54.0%)
- **حد ضرر:** 14,145 ریال (ریسک: 12.5%)
...
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 36.56 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 15,375 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **تاریخ صدور گواهی:** `1405/06/21 - 15:37`
