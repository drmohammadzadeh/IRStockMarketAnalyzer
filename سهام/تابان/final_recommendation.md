...
**امتیاز اجماع توصیه معاملاتی:** **4.9 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)**  
**آخرین قیمت معاملاتی:** 14,380 ریال  
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **5.0** | افق کوتاه‌مدت (9.5/۱۰) + میان‌مدت (9.2/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=4.63 |
| **🌟 امتیاز نهایی اجماع (Composite Score)** | **4.9 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)** |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **14,092 تا 14,668 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **16,106 ریال** | **+12.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **17,716 ریال** | **+23.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **14,007 ریال** | **-2.6%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **4.63** | — | 🟢 جذاب (R/R >= 2) |
...
- **تارگت هدف:** 16,106 ریال (بازدهی مورد انتظار: 12.0%)
- **حد ضرر:** 14,007 ریال (حداکثر ریسک: 2.6%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 17,716 ریال (بازدهی مورد انتظار: 23.2%)
- **حد ضرر:** 13,587 ریال (ریسک: 5.5%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 22,145 ریال (بازدهی مورد انتظار: 54.0%)
- **حد ضرر:** 12,887 ریال (ریسک: 10.4%)
...
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 35.77 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 14,007 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 12,800 ریال.
...
- **تاریخ صدور گواهی:** `1405/06/16 - 09:02`
