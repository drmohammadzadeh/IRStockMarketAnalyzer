...
**تاریخ تحلیل:** 1405/06/15 - 19:04  
**آخرین قیمت معاملاتی:** 14,380 ریال | **دامنه روز:** 14,380 تا 14,380 ریال  
**حجم معاملات آخرین روز:** 39,077,343 برگه سهم (میانگین ۲۰ روزه: 39,077,343)
...
- **سقف ماژور دوره (Swing High):** 14,380 ریال
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 13,138 | +9.5% | حمایت پویا |
| **EMA 50** | 12,947 | +11.1% | حمایت میان‌مدت |
| **EMA 100** | 12,876 | +11.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 12,838 | +12.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 14,380 ریال
- **باند میانی (SMA 20):** 14,380 ریال
- **باند پایینی (Lower Band):** 14,380 ریال
- **عرض باند (Bandwidth):** 0.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 14,380 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 14,380 ریال
- **ابر کومو اسپن A (Senkou Span A):** 14,380 ریال
- **ابر کومو اسپن B (Senkou Span B):** 14,380 ریال
...
- **مکدی (MACD 12,26,9):** 247.09 | **خط سیگنال:** 88.74 | **هیستوگرام:** 158.35
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 12,800 و سقف 14,380 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 14,380 | +0.0% | سقف موج (Pivot High) |
| **0.236** | 14,007 | +2.7% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 13,776 | +4.4% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,590 | +5.8% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,404 | +7.3% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 13,138 | +9.5% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 12,800 | +12.3% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **14,007 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **14,380 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **35.63** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی))
- **سرانه خرید حقیقی:** 84,171 سهم | **سرانه فروش حقیقی:** 2,362 سهم
- **حجم خرید حقیقی:** 25,840,563 سهم | **حجم خرید حقوقی:** 900,000 سهم
- **حجم فروش حقیقی:** 17,629,473 سهم | **حجم فروش حقوقی:** 9,111,090 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **14,380 ریال** در مقایسه با میانگین ۲۰ روزه (13,138 ریال) و میانگین ۵۰ روزه (12,947 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **50.0** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+158.35** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **35.63** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی)) با سرانه خرید **84,171 سهم** ثبت گردیده است.
