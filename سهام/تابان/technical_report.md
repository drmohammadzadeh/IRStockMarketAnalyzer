...
**حجم معاملات آخرین روز:** 0 برگه سهم (میانگین ۲۰ روزه: 0)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 13,256 | +8.5% | حمایت پویا |
| **EMA 50** | 13,003 | +10.6% | حمایت میان‌مدت |
| **EMA 100** | 12,906 | +11.4% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 12,854 | +11.9% | مرز روند بلندمدت و استراتژیک |
...
- **مکدی (MACD 12,26,9):** 313.69 | **خط سیگنال:** 133.73 | **هیستوگرام:** 179.97
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **14,380 ریال** در مقایسه با میانگین ۲۰ روزه (13,256 ریال) و میانگین ۵۰ روزه (13,003 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **50.0** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+179.97** نوسان می‌کند.
