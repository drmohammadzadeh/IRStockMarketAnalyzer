...
**تاریخ تحلیل:** 1405/06/16 - 11:38  
**آخرین قیمت معاملاتی:** 14,810 ریال | **دامنه روز:** 14,810 تا 14,810 ریال  
**حجم معاملات آخرین روز:** 27,822,152 برگه سهم (میانگین ۲۰ روزه: 27,822,152)
...
- **سقف ماژور دوره (Swing High):** 14,810 ریال
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 13,297 | +11.4% | حمایت پویا |
| **EMA 50** | 13,020 | +13.7% | حمایت میان‌مدت |
| **EMA 100** | 12,914 | +14.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 12,858 | +15.2% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 14,810 ریال
- **باند میانی (SMA 20):** 14,810 ریال
- **باند پایینی (Lower Band):** 14,810 ریال
- **عرض باند (Bandwidth):** 0.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 14,810 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 14,810 ریال
- **ابر کومو اسپن A (Senkou Span A):** 14,810 ریال
- **ابر کومو اسپن B (Senkou Span B):** 14,810 ریال
...
- **مکدی (MACD 12,26,9):** 348.00 | **خط سیگنال:** 140.59 | **هیستوگرام:** 207.41
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 12,800 و سقف 14,810 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 14,810 | +0.0% | سقف موج (Pivot High) |
| **0.236** | 14,336 | +3.3% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,042 | +5.5% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,805 | +7.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,568 | +9.2% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 13,230 | +11.9% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 12,800 | +15.7% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **14,336 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **14,810 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **35.77** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی))
- **سرانه خرید حقیقی:** 84,494 سهم | **سرانه فروش حقیقی:** 2,362 سهم
- **حجم خرید حقیقی:** 37,684,275 سهم | **حجم خرید حقوقی:** 1,393,068 سهم
- **حجم فروش حقیقی:** 19,069,565 سهم | **حجم فروش حقوقی:** 20,007,778 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **14,810 ریال** در مقایسه با میانگین ۲۰ روزه (13,297 ریال) و میانگین ۵۰ روزه (13,020 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **50.0** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+207.41** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **35.77** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی)) با سرانه خرید **84,494 سهم** ثبت گردیده است.
