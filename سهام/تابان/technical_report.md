...
**آخرین قیمت معاملاتی:** 12,800 ریال | **دامنه روز:** 12,800 تا 12,800 ریال  
**حجم معاملات آخرین روز:** 5,999,978,423 برگه سهم (میانگین ۲۰ روزه: 5,999,978,423)
...
- **سقف ماژور دوره (Swing High):** 12,800 ریال
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 12,800 | +0.0% | حمایت پویا |
| **EMA 50** | 12,800 | +0.0% | حمایت میان‌مدت |
| **EMA 100** | 12,800 | +0.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 12,800 | +0.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 12,800 ریال
- **باند میانی (SMA 20):** 12,800 ریال
- **باند پایینی (Lower Band):** 12,800 ریال
- **عرض باند (Bandwidth):** 0.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 12,800 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 12,800 ریال
- **ابر کومو اسپن A (Senkou Span A):** 12,800 ریال
- **ابر کومو اسپن B (Senkou Span B):** 12,800 ریال
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 12,800 و سقف 12,800 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |

- **نزدیک‌ترین سطح حمایت معتبر:** **12,160 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **13,440 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **1.00** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 3,010 سهم | **سرانه فروش حقیقی:** 0 سهم
- **حجم خرید حقیقی:** 5,993,786,258 سهم | **حجم خرید حقوقی:** 6,192,165 سهم
- **حجم فروش حقیقی:** 0 سهم | **حجم فروش حقوقی:** 5,999,978,423 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **12,800 ریال** در مقایسه با میانگین ۲۰ روزه (12,800 ریال) و میانگین ۵۰ روزه (12,800 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.00** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **3,010 سهم** ثبت گردیده است.
