...
**آخرین قیمت معاملاتی:** 13,970 ریال | **دامنه روز:** 13,970 تا 13,970 ریال  
**حجم معاملات آخرین روز:** 26,740,563 برگه سهم (میانگین ۲۰ روزه: 26,740,563)
...
- **سقف ماژور دوره (Swing High):** 13,970 ریال
- **کف ماژور دوره (Swing Low):** 13,970 ریال
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 13,970 | +0.0% | حمایت پویا |
| **EMA 50** | 13,970 | +0.0% | حمایت میان‌مدت |
| **EMA 100** | 13,970 | +0.0% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,970 | +0.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 13,970 ریال
- **باند میانی (SMA 20):** 13,970 ریال
- **باند پایینی (Lower Band):** 13,970 ریال
- **عرض باند (Bandwidth):** 0.0% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 13,970 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 13,970 ریال
- **ابر کومو اسپن A (Senkou Span A):** 13,970 ریال
- **ابر کومو اسپن B (Senkou Span B):** 13,970 ریال
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 13,970 و سقف 13,970 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |

- **نزدیک‌ترین سطح حمایت معتبر:** **13,272 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **14,668 ریال**
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **13,970 ریال** در مقایسه با میانگین ۲۰ روزه (13,970 ریال) و میانگین ۵۰ روزه (13,970 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
