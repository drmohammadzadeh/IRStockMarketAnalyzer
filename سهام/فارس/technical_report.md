# گزارش تحلیلی جامع تکنیکال و تابلوخوانی نماد فارس

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/22 - 12:50  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
**تاریخ تحلیل:** 1405/06/22 - 12:50  
**آخرین قیمت معاملاتی:** 13,140 ریال | **دامنه روز:** 12,870 تا 13,160 ریال  
**حجم معاملات آخرین روز:** 431,366,949 برگه سهم (میانگین ۲۰ روزه: 270,045,950)
...
- **سقف ماژور دوره (Swing High):** 13,730 ریال
- **کف ماژور دوره (Swing Low):** 8,510 ریال
- **دامنه نوسان واقعی (ATR 14):** 364 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 11,655 | +12.7% | حمایت پویا |
| **EMA 50** | 11,468 | +14.6% | حمایت میان‌مدت |
| **EMA 100** | 11,065 | +18.8% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 10,286 | +27.7% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 13,399 ریال
- **باند میانی (SMA 20):** 11,040 ریال
- **باند پایینی (Lower Band):** 8,682 ریال
- **عرض باند (Bandwidth):** 42.7% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 12,105 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 11,185 ریال
- **ابر کومو اسپن A (Senkou Span A):** 12,388 ریال
- **ابر کومو اسپن B (Senkou Span B):** 11,900 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **69.4** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 389.65 | **خط سیگنال:** 66.05 | **هیستوگرام:** 323.60
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 8,510 و سقف 13,730 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 13,730 | -4.3% | سقف موج (Pivot High) |
| **0.236** | 12,498 | +5.1% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 11,736 | +12.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 11,120 | +18.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 10,504 | +25.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 9,627 | +36.5% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 8,510 | +54.4% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **12,498 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **13,730 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **1.51** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی))
- **سرانه خرید حقیقی:** 137,813 سهم | **سرانه فروش حقیقی:** 91,067 سهم
- **حجم خرید حقیقی:** 163,859,096 سهم | **حجم خرید حقوقی:** 64,743,531 سهم
- **حجم فروش حقیقی:** 158,184,127 سهم | **حجم فروش حقوقی:** 70,418,500 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **13,140 ریال** در مقایسه با میانگین ۲۰ روزه (11,655 ریال) و میانگین ۵۰ روزه (11,468 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **69.4** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+323.60** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.51** (قدرت خریدار بسیار عالی (ورود پول هوشمند و خرید قدرتمند توسط کدهای درشت حقیقی)) با سرانه خرید **137,813 سهم** ثبت گردیده است.
