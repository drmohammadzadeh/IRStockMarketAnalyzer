# 📊 شناسنامه و داشبورد تحلیلی نماد فارس (صنايع پتروشيمي خليج فارس)

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/22 - 12:50  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «فارس»**  
> *تهیه‌شده توسط سامانه تحلیل چندعاملی بازار سرمایه ایران (IRStockMarketAnalyzer)*  
> *تاریخ آخرین به‌روزرسانی بر مبنای آخرین معاملات بازار:* 1405/06/22 - 12:50  
...
| :--- | :--- |
| **نماد معاملاتی** | **فارس** |
| **نام شرکت / دارایی** | صنايع پتروشيمي خليج فارس |
| **بازار معاملاتی** | بورس اوراق بهادار تهران (بازار دوم - تابلوی اصلی) |
| **وضعیت تابلو و صف** | تقاضای پرحجم با ورود پول هوشمند حقیقی |
...
| :--- | :--- | :--- |
| **سیگنال استراتژی** | **خرید پله‌ای (Accumulate)** | سهم دارای ارزندگی ممتاز و ورود پرقدرت نقدینگی است؛ ورود مرحله‌ای و پله‌ای در محدوده مشخص‌شده توصیه می‌شود. |
| **امتیاز هوش مصنوعی (TJB24.ir AI Score)** | **۷.۹ از ۱۰ (سطح ۸)** | 🟢 سیگنال خرید قوی (بنیادی: ۹.۵، تکنیکال: ۸.۰، سنتیمنت: ۷.۷، ریسک پایین: ۵.۵) |
| **آخرین قیمت معامله** | **13,140 ریال** | بازدهی روزانه: **+۲.۸۲٪** (ثبت نوسانات پایان بازار 1405/06/22) |
| **محدوده خرید بهینه** | **12,877 تا 13,403 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **13,730 ریال** | مقاومت اول و هدف نوسانی (+۴.۵٪) |
| **حد سود دوم (میان‌مدت)** | **15,103 ریال** | سقف کانال ماژور و مقاومت کلیدی (+۱۴.۹٪) |
| **حد ضرر پویا (Dynamic SL)** | **12,316 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR (-۶.۳٪) |
| **نسبت سود به ریسک (R/R)** | **0.72** | 🔴 نیازمند انضباط حد ضرر و ورود در کف‌های قیمتی |
| **قدرت خریدار حقیقی** | **1.51** | 🟢 ورود پرقدرت پول هوشمند و برتری محسوس خریداران حقیقی |
...
## 📂 ساختار گزارش‌ها و فایل‌های استخراج‌شده نماد فارس
