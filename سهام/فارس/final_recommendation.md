# جمع‌بندی تحلیلی و پیشنهاد معاملاتی نماد فارس
...
**امتیاز اجماع توصیه معاملاتی:** **4.4 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)**  
**آخرین قیمت معاملاتی:** 13,140 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.4** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (8.5/۱۰ با وزن ۲۵٪) + اخبار (5.8/۱۰ با وزن ۱۰٪) |
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.9** | افق کوتاه‌مدت (8.2/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.72 |
| **🌟 امتیاز نهایی اجماع (Composite Score)** | **4.4 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **12,877 تا 13,403 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **13,730 ریال** | **+4.5%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **15,103 ریال** | **+14.9%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **12,316 ریال** | **-6.3%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.72** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 13,730 ریال (بازدهی مورد انتظار: 4.5%)
- **حد ضرر:** 12,316 ریال (حداکثر ریسک: 6.3%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 15,103 ریال (بازدهی مورد انتظار: 14.9%)
- **حد ضرر:** 11,946 ریال (ریسک: 9.1%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 18,879 ریال (بازدهی مورد انتظار: 43.7%)
- **حد ضرر:** 11,498 ریال (ریسک: 12.5%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 69.4 - ATR: 364 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 1.51 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 12,316 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 8,510 ریال.
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد فارس

- **نماد تحت ممیزی:** `فارس`
- **تاریخ صدور گواهی:** `1405/06/22 - 12:50`
