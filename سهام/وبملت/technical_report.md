# گزارش تحلیلی جامع تکنیکال و تابلوخوانی نماد وبملت

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/21 - 17:18  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
**تاریخ تحلیل:** 1405/06/21 - 17:18  
**آخرین قیمت معاملاتی:** 1,515 ریال | **دامنه روز:** 1,458 تا 1,545 ریال  
**حجم معاملات آخرین روز:** 11,238,617,306 برگه سهم (میانگین ۲۰ روزه: 9,793,394,369)
...
- **سقف ماژور دوره (Swing High):** 1,652 ریال
- **کف ماژور دوره (Swing Low):** 887 ریال
- **دامنه نوسان واقعی (ATR 14):** 55 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 1,445 | +4.8% | حمایت پویا |
| **EMA 50** | 1,357 | +11.7% | حمایت میان‌مدت |
| **EMA 100** | 1,334 | +13.6% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 1,447 | +4.7% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 1,638 ریال
- **باند میانی (SMA 20):** 1,440 ریال
- **باند پایینی (Lower Band):** 1,242 ریال
- **عرض باند (Bandwidth):** 27.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 1,521 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 1,400 ریال
- **ابر کومو اسپن A (Senkou Span A):** 1,199 ریال
- **ابر کومو اسپن B (Senkou Span B):** 1,160 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **63.8** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 67.71 | **خط سیگنال:** 68.90 | **هیستوگرام:** -1.19
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 887 و سقف 1,652 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 1,652 | -8.3% | سقف موج (Pivot High) |
| **0.236** | 1,471 | +3.0% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 1,360 | +11.4% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 1,270 | +19.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 1,179 | +28.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 1,051 | +44.2% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 887 | +70.8% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **1,471 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **1,652 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.51** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 679,014 سهم | **سرانه فروش حقیقی:** 1,326,831 سهم
- **حجم خرید حقیقی:** 8,706,993,263 سهم | **حجم خرید حقوقی:** 3,080,600,688 سهم
- **حجم فروش حقیقی:** 7,198,057,775 سهم | **حجم فروش حقوقی:** 4,589,536,176 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **1,515 ریال** در مقایسه با میانگین ۲۰ روزه (1,445 ریال) و میانگین ۵۰ روزه (1,357 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **63.8** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-1.19** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.51** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **679,014 سهم** ثبت گردیده است.
