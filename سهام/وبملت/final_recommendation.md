# جمع‌بندی تحلیلی و پیشنهاد معاملاتی نماد وبملت
...
**آخرین قیمت معاملاتی:** 1,515 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.7** | بنیادی (9.0/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (5.2/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.9** | افق کوتاه‌مدت (5.2/۱۰) + میان‌مدت (8.5/۱۰) + بلندمدت (8.5/۱۰) با ضریب R/R=1.93 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **1,485 تا 1,545 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **1,652 ریال** | **+9.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **1,817 ریال** | **+19.9%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **1,444 ریال** | **-4.7%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.93** | — | 🟡 قابل قبول (R/R >= 1.5) |
...
- **تارگت هدف:** 1,652 ریال (بازدهی مورد انتظار: 9.0%)
- **حد ضرر:** 1,444 ریال (حداکثر ریسک: 4.7%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 1,817 ریال (بازدهی مورد انتظار: 19.9%)
- **حد ضرر:** 1,401 ریال (ریسک: 7.5%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 2,272 ریال (بازدهی مورد انتظار: 49.9%)
- **حد ضرر:** 1,354 ریال (ریسک: 10.6%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 63.8 - ATR: 55 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.51 | تعادل یا برتری عرضه |
| **تحلیل بنیادی و صورت‌های مالی** | نمره ارزیابی: 9.0/۱۰ - نسبت P/E: 6.5 | ارزندگی بالا و حاشیه سود پایدار |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 1,444 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 887 ریال.
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد وبملت

- **نماد تحت ممیزی:** `وبملت`
- **تاریخ صدور گواهی:** `1405/06/21 - 17:18`
