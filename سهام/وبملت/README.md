# 📊 شناسنامه و داشبورد تحلیلی نماد وبملت (بانک ملت)

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/21 - 17:18  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «وبملت»**  
> *تهیه‌شده توسط سامانه تحلیل چندعاملی بازار سرمایه ایران (IRStockMarketAnalyzer)*  
> *تاریخ آخرین به‌روزرسانی بر مبنای آخرین معاملات بازار:* 1405/06/21 - 17:18  
...
| :--- | :--- |
| **نماد معاملاتی** | **وبملت** |
| **نام شرکت / دارایی** | بانک ملت |
| **بازار معاملاتی** | بورس اوراق بهادار تهران (بازار اول - تابلوی اصلی) |
| **وضعیت تابلو و صف** | معاملات روان با گرایش مثبت خریداران |
...
| **امتیاز هوش مصنوعی (TJB24.ir AI Score)** | **۷.۰ از ۱۰ (سطح ۷)** | 🟢 سیگنال خرید (بنیادی: ۹.۰، تکنیکال: ۸.۰، سنتیمنت: ۳.۳، ریسک پایین: ۶.۱) |
| **آخرین قیمت معامله** | **1,515 ریال** | بازدهی روزانه: **+۰.۸۷٪** (ثبت نوسانات پایان بازار 1405/06/21) |
| **محدوده خرید بهینه** | **1,485 تا 1,545 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **1,652 ریال** | مقاومت اول و هدف نوسانی (+۹.۰٪) |
| **حد سود دوم (میان‌مدت)** | **1,817 ریال** | سقف کانال ماژور و مقاومت کلیدی (+۱۹.۹٪) |
| **حد ضرر پویا (Dynamic SL)** | **1,444 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR (-۴.۷٪) |
| **نسبت سود به ریسک (R/R)** | **1.93** | 🟢 بسیار مطلوب (R/R >= 1.5) |
| **قدرت خریدار حقیقی** | **0.51** | برتری مقطعی فروشندگان و فرصت ورود پله‌ای در محدوده‌های حمایتی |
...
## 📂 ساختار گزارش‌ها و فایل‌های استخراج‌شده نماد وبملت
