...
**آخرین قیمت معاملاتی:** 983 ریال | **دامنه روز:** 953 تا 1,011 ریال  
**حجم معاملات آخرین روز:** 22,946,477,418 برگه سهم (میانگین ۲۰ روزه: 11,269,019,581)
...
- **دامنه نوسان واقعی (ATR 14):** 32 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 863 | +13.9% | حمایت پویا |
| **EMA 50** | 732 | +34.3% | حمایت میان‌مدت |
| **EMA 100** | 645 | +52.3% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 650 | +51.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 1,082 ریال
- **باند میانی (SMA 20):** 845 ریال
- **باند پایینی (Lower Band):** 608 ریال
- **عرض باند (Bandwidth):** 56.1% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 958 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 799 ریال
- **ابر کومو اسپن A (Senkou Span A):** 576 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **83.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 97.09 | **خط سیگنال:** 86.63 | **هیستوگرام:** 10.46
...
| :--- | :--- | :--- | :--- |
| **0.0** | 1,042 | -5.7% | سقف موج (Pivot High) |
| **0.236** | 883 | +11.3% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 785 | +25.2% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 706 | +39.3% | تراز میانی تعادلی (50.0%) |
| **0.618** | 626 | +57.0% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 513 | +91.6% | آخرین سد دفاعی روند (78.6%) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.58** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 1,988,401 سهم | **سرانه فروش حقیقی:** 3,406,564 سهم
- **حجم خرید حقیقی:** 19,697,100,324 سهم | **حجم خرید حقوقی:** 3,249,377,094 سهم
- **حجم فروش حقیقی:** 18,838,296,747 سهم | **حجم فروش حقوقی:** 4,108,180,671 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **983 ریال** در مقایسه با میانگین ۲۰ روزه (863 ریال) و میانگین ۵۰ روزه (732 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **83.0** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+10.46** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.58** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **1,988,401 سهم** ثبت گردیده است.
