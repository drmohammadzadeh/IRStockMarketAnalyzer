...
**آخرین قیمت معاملاتی:** 986 ریال | **دامنه روز:** 986 تا 986 ریال  
**حجم معاملات آخرین روز:** 2,143,816,389 برگه سهم (میانگین ۲۰ روزه: 11,643,759,024)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 883 | +11.7% | حمایت پویا |
| **EMA 50** | 750 | +31.4% | حمایت میان‌مدت |
| **EMA 100** | 658 | +49.8% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 656 | +50.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 1,090 ریال
- **باند میانی (SMA 20):** 875 ریال
- **باند پایینی (Lower Band):** 660 ریال
- **عرض باند (Bandwidth):** 49.2% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 985 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 808 ریال
- **ابر کومو اسپن A (Senkou Span A):** 571 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **77.8** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 90.31 | **خط سیگنال:** 88.33 | **هیستوگرام:** 1.98
...
| :--- | :--- | :--- | :--- |
| **0.0** | 1,042 | -5.4% | سقف موج (Pivot High) |
| **0.236** | 883 | +11.6% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 785 | +25.6% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 706 | +39.8% | تراز میانی تعادلی (50.0%) |
| **0.618** | 626 | +57.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 513 | +92.2% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 369 | +167.2% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.41** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 1,383,669 سهم | **سرانه فروش حقیقی:** 3,351,865 سهم
- **حجم خرید حقیقی:** 12,230,248,474 سهم | **حجم خرید حقوقی:** 8,319,324,898 سهم
- **حجم فروش حقیقی:** 16,598,437,391 سهم | **حجم فروش حقوقی:** 3,951,135,981 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **986 ریال** در مقایسه با میانگین ۲۰ روزه (883 ریال) و میانگین ۵۰ روزه (750 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **77.8** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+1.98** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.41** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **1,383,669 سهم** ثبت گردیده است.
