...
**آخرین قیمت معاملاتی:** 971 ریال | **دامنه روز:** 949 تا 1,000 ریال  
**حجم معاملات آخرین روز:** 11,169,744,873 برگه سهم (میانگین ۲۰ روزه: 11,065,347,602)
...
- **دامنه نوسان واقعی (ATR 14):** 36 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 909 | +6.8% | حمایت پویا |
| **EMA 50** | 777 | +25.0% | حمایت میان‌مدت |
| **EMA 100** | 677 | +43.4% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 666 | +45.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 1,094 ریال
- **باند میانی (SMA 20):** 915 ریال
- **باند پایینی (Lower Band):** 736 ریال
- **عرض باند (Bandwidth):** 39.2% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 996 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 842 ریال
- **ابر کومو اسپن A (Senkou Span A):** 578 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **69.6** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 80.04 | **خط سیگنال:** 86.22 | **هیستوگرام:** -6.19
...
| :--- | :--- | :--- | :--- |
| **0.0** | 1,042 | -6.8% | سقف موج (Pivot High) |
| **0.236** | 883 | +9.9% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 785 | +23.7% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 706 | +37.6% | تراز میانی تعادلی (50.0%) |
| **0.618** | 626 | +55.1% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 513 | +89.3% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 369 | +163.1% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **0.30** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 962,454 سهم | **سرانه فروش حقیقی:** 3,207,373 سهم
- **حجم خرید حقیقی:** 6,907,533,605 سهم | **حجم خرید حقوقی:** 1,920,246,760 سهم
- **حجم فروش حقیقی:** 7,646,377,848 سهم | **حجم فروش حقوقی:** 1,181,402,517 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **971 ریال** در مقایسه با میانگین ۲۰ روزه (909 ریال) و میانگین ۵۰ روزه (777 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **69.6** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **-6.19** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.30** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **962,454 سهم** ثبت گردیده است.
