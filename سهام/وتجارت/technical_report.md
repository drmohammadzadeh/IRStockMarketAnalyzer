...
**آخرین قیمت معاملاتی:** 982 ریال | **دامنه روز:** 982 تا 1,025 ریال  
**حجم معاملات آخرین روز:** 1,980,500,000 برگه سهم (میانگین ۲۰ روزه: 7,811,494,194)
...
- **سقف ماژور دوره (Swing High):** 1,025 ریال
- **کف ماژور دوره (Swing Low):** 369 ریال
- **دامنه نوسان واقعی (ATR 14):** 29 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 834 | +17.8% | حمایت پویا |
| **EMA 50** | 710 | +38.3% | حمایت میان‌مدت |
| **EMA 100** | 631 | +55.6% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 643 | +52.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 1,053 ریال
- **باند میانی (SMA 20):** 809 ریال
- **باند پایینی (Lower Band):** 564 ریال
- **عرض باند (Bandwidth):** 60.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 918 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 768 ریال
- **ابر کومو اسپن A (Senkou Span A):** 585 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **83.5** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 97.40 | **خط سیگنال:** 79.85 | **هیستوگرام:** 17.55
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 369 و سقف 1,025 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 1,025 | -4.2% | سقف موج (Pivot High) |
| **0.236** | 870 | +12.9% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 774 | +26.8% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 697 | +40.9% | تراز میانی تعادلی (50.0%) |
| **0.618** | 620 | +58.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 509 | +92.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 369 | +166.1% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **870 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **1,025 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.81** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 530,612 سهم | **سرانه فروش حقیقی:** 652,174 سهم
- **حجم خرید حقیقی:** 520,000,000 سهم | **حجم خرید حقوقی:** 150,000,000 سهم
- **حجم فروش حقیقی:** 2,250,000,000 سهم | **حجم فروش حقوقی:** 60,500,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **982 ریال** در مقایسه با میانگین ۲۰ روزه (834 ریال) و میانگین ۵۰ روزه (710 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **83.5** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+17.55** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.81** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **530,612 سهم** ثبت گردیده است.
