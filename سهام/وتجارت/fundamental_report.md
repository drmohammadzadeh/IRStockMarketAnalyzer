...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی (فروش کل)** | صعودی | 3,616,931 | افزایش حجم تولید و رشد نرخ فروش محصولات در بورس کالا / بازار آزاد |
| **سود ناخالص** | پایدار و صعودی | 1,265,926 | حاشیه سود ناخالص در تراز 35.0% تثبیت شده است |
| **سود عملیاتی (Operating Profit)** | پرقدرت | 976,571 | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | 192 | سود خالص با حاشیه 0.0% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **مجموع دارایی‌ها (Total Assets):** 2,802,936 ریال
- **سپرده‌های سرمایه‌گذاری و مشتریان (Deposits):** 40,648,240 ریال
- **تسهیلات اعطایی و مطالبات (Loans):** 43,570 ریال
- **نسبت تسهیلات به سپرده‌ها (LDR):** 0.1% (بیانگر بهره‌وری واسطه‌گری وجوه)
- **سرمایه ثبت‌شده (Capital):** 1,800,000 ریال
- **سود (زیان) انباشته (Retained Earnings):** -337,352 ریال
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** 3,546,791 ریال
...
| :--- | :--- | :--- | :--- |
| **نسبت P/E ttm** | **4973958333.33** | 7.50 | متعادل |
| **نسبت P/E فوروارد (تخمینی)** | **4973958333.33** | 5.5 - 7.0 | جذاب برای سرمایه‌گذاری میان‌مدت |
| **نسبت قیمت به فروش (P/S)** | **264036.00** | 1.2 - 2.0 | منصفانه |
| **نسبت قیمت به ارزش دفتری (P/B)** | **269257.48** | 2.5 - 4.0 | متناسب با بازده حقوق صاحبان سهام (ROE) |
...
> **تحلیل تطبیقی گروه:** نسبت P/E سهم (4973958333.3) بالاتر از میانگین گروه (7.5) معامله می‌شود که نیازمند تحقق رشدهای عملیاتی بالاتر برای توجیه است.
...
- **جمع‌بندی نهایی:** نماد **وتجارت** با اتکا به نسبت P/E جذاب (4973958333.33)، پایداری حاشیه سود (35.0% ناخالص)، روند باثبات در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (0.0%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
