...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **175,916,365 میلیون ریال** (معادل **17.59 همت** / 175,916,365,371,200 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **47,497,419 میلیون ریال** (معادل **4.75 همت** / 47,497,418,650,224 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **33,830,070 میلیون ریال** (معادل **3.38 همت** / 33,830,070,263,692 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **78,534,092 میلیون ریال** (معادل **7.85 همت** / 78,534,091,683,571 ریال)
...
- **جمع‌بندی نهایی:** نماد **وتجارت** با اتکا به نسبت P/E جذاب (6.50)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (10.8%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
