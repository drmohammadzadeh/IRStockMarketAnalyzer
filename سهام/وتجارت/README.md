...
> *تاریخ آخرین به‌روزرسانی بر مبنای آخرین معاملات بازار:* 1405/06/21 - 17:15  
...
| **وضعیت تابلو و صف** | معاملات روان با فشار عرضه مقطعی |
...
| **امتیاز هوش مصنوعی (TJB24.ir AI Score)** | **۶.۹ از ۱۰ (سطح ۷)** | 🟡 سیگنال نگهداری (بنیادی: ۹.۵، تکنیکال: ۸.۰، سنتیمنت: ۳.۵، ریسک پایین: ۴.۸) |
| **آخرین قیمت معامله** | **971 ریال** | ثبت نوسانات پایان بازار 1405/06/21 |
| **محدوده خرید بهینه** | **952 تا 990 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **1,042 ریال** | مقاومت اول و هدف نوسانی (+۷.۳٪) |
| **حد سود دوم (میان‌مدت)** | **1,146 ریال** | سقف کانال ماژور و مقاومت کلیدی (+۱۸.۰٪) |
| **حد ضرر پویا (Dynamic SL)** | **874 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR (-۱۰.۰٪) |
| **نسبت سود به ریسک (R/R)** | **0.73** | 🔴 نیازمند احتیاط (R/R < 1.5) |
| **قدرت خریدار حقیقی** | **0.30** | برتری مقطعی فروشندگان و احتیاط خریداران خرد |
