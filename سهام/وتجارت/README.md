...
| **آخرین قیمت معامله** | **983 ریال** | ثبت نوسانات پایان بازار 1405/06/14 |
| **محدوده خرید بهینه** | **963 تا 1,003 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **1,042 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **1,146 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **885 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.60** | 🔴 نیازمند احتیاط (R/R < 1.5) |
