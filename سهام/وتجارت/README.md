...
| **آخرین قیمت معامله** | **986 ریال** | ثبت نوسانات پایان بازار 1405/06/16 |
| **محدوده خرید بهینه** | **966 تا 1,006 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **1,042 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **1,146 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **887 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.57** | 🔴 نیازمند احتیاط (R/R < 1.5) |
