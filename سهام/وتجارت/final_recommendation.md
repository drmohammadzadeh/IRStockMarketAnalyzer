...
**تاریخ تدوین استراتژی:** 1405/06/14 - 10:35  
**سیگنال و وضعیت نهایی:** **خرید پله‌ای (Accumulate)**  
**امتیاز اجماع توصیه معاملاتی:** **3.6 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)**  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.5** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (6.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (5.8/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.3** | افق کوتاه‌مدت (4.2/۱۰) + میان‌مدت (7.7/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.61 |
...
| **حد سود اول (Target 1)** | **1,042 ریال** | **+6.1%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **1,146 ریال** | **+16.7%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **884 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.61** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 1,042 ریال (بازدهی مورد انتظار: 6.1%)
...
- **تارگت هدف:** 1,146 ریال (بازدهی مورد انتظار: 16.7%)
...
- **تارگت هدف:** 1,433 ریال (بازدهی مورد انتظار: 45.9%)
- **حد ضرر:** 813 ریال (ریسک: 17.3%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 82.9 - ATR: 31 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.55 | تعادل یا برتری عرضه |
...
- **تاریخ صدور گواهی:** `1405/06/14 - 10:35`
