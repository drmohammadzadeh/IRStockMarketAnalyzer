...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.3** | افق کوتاه‌مدت (4.2/۱۰) + میان‌مدت (7.7/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.60 |
...
| **حد سود اول (Target 1)** | **1,042 ریال** | **+6.0%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **1,146 ریال** | **+16.6%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **885 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.6** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 1,042 ریال (بازدهی مورد انتظار: 6.0%)
...
- **تارگت هدف:** 1,146 ریال (بازدهی مورد انتظار: 16.6%)
...
- **تارگت هدف:** 1,433 ریال (بازدهی مورد انتظار: 45.8%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 83.0 - ATR: 32 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.58 | تعادل یا برتری عرضه |
