...
**آخرین قیمت:** 17,142 ریال | **ارزش بازار:** **1,271.91 همت** (12,719,116,006,686,000 ریال)  
...
| **سود خالص (Net Income)** | پایدار | **1,956,787,078 میلیون ریال** (معادل **195.68 همت** / 1,956,787,077,951,692 ریال) | سود خالص با حاشیه 97839353897.6% نشان‌دهنده جریان نقد واقعی پایدار است |
...
| **حاشیه سود خالص (Net Margin)** | **97839353897.6%** | حاشیه خالص جذاب در مقایسه با نرخ بازده بدون ریسک بازار |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **4,542,541,431 میلیون ریال** (معادل **454.25 همت** / 4,542,541,430,959,286 ریال)
...
| **نسبت قیمت به فروش (P/S)** | **6359558003.34** | 1.2 - 2.0 | منصفانه |
| **نسبت قیمت به ارزش دفتری (P/B)** | **2.80** | 2.5 - 4.0 | متناسب با بازده حقوق صاحبان سهام (ROE) |
| **سود هر سهم دوره اخیر (EPS ttm)** | **2,637 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **2,954 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,846 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
