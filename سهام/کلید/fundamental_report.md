...
**آخرین قیمت:** 17,120 ریال | **ارزش بازار:** **1,270.28 همت** (12,702,792,324,960,000 ریال)  
...
| **سود خالص (Net Income)** | پایدار | **1,954,275,742 میلیون ریال** (معادل **195.43 همت** / 1,954,275,742,301,538 ریال) | سود خالص با حاشیه 97713787115.1% نشان‌دهنده جریان نقد واقعی پایدار است |
...
| **حاشیه سود خالص (Net Margin)** | **97713787115.1%** | حاشیه خالص جذاب در مقایسه با نرخ بازده بدون ریسک بازار |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **4,536,711,545 میلیون ریال** (معادل **453.67 همت** / 4,536,711,544,628,572 ریال)
...
| **نسبت قیمت به فروش (P/S)** | **6351396162.48** | 1.2 - 2.0 | منصفانه |
| **نسبت قیمت به ارزش دفتری (P/B)** | **2.80** | 2.5 - 4.0 | متناسب با بازده حقوق صاحبان سهام (ROE) |
| **سود هر سهم دوره اخیر (EPS ttm)** | **2,634 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **2,950 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,844 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
...
- **امتیاز سلامت بنیادی:** **8.0 از ۱۰**
- **رأی ارزندگی تحلیلی:** **فرصت خرید بنیادی (Undervalued / Attractive)**
- **جمع‌بندی نهایی:** نماد **کلید** با اتکا به نسبت P/E جذاب (6.50)، پایداری حاشیه سود (35.0% ناخالص)، روند صعودی (رشد فروش) در گزارش‌های ماهانه و پتانسیل بازده نقدی مجمع (10.8%)، در زمره گزینه‌های باارزش سرمایه‌گذاری با ریسک کنترل‌شده ارزیابی می‌شود.
