...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **13,657,600 میلیون ریال** (معادل **1.37 همت** / 13,657,600,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **3,687,552 میلیون ریال** (معادل **368.8 میلیارد تومان** / 3,687,552,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **2,626,462 میلیون ریال** (معادل **262.6 میلیارد تومان** / 2,626,461,538,462 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **6,097,143 میلیون ریال** (معادل **609.7 میلیارد تومان** / 6,097,142,857,143 ریال)
...
| **سود هر سهم دوره اخیر (EPS ttm)** | **2,626 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **2,942 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,839 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
