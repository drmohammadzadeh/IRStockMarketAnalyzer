...
**آخرین قیمت:** 17,554 ریال | **ارزش بازار:** **1.76 همت** (17,554,000,000,000 ریال)  
...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **14,043,200 میلیون ریال** (معادل **1.40 همت** / 14,043,200,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **3,791,664 میلیون ریال** (معادل **379.2 میلیارد تومان** / 3,791,664,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **2,700,615 میلیون ریال** (معادل **270.1 میلیارد تومان** / 2,700,615,384,615 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **6,269,286 میلیون ریال** (معادل **626.9 میلیارد تومان** / 6,269,285,714,286 ریال)
...
| **سود هر سهم دوره اخیر (EPS ttm)** | **2,701 ریال** | - | مبنای محاسبه ضریب تاریخی |
| **سود برآوردی هر سهم (Forward EPS)** | **3,025 ریال** | - | با فرض تداوم عملکرد ماهانه |
| **سود تقسیمی برآوردی (DPS)** | **1,890 ریال** | - | با فرض درصد تقسیم سود ۶۰ الی ۷۰ درصدی |
