...
**آخرین قیمت:** 17,416 ریال | **ارزش بازار:** **1.74 همت** (17,416,000,000,000 ریال)  
...
| :--- | :--- | :--- | :--- |
| **درآمد عملیاتی / درآمد تسهیلات** | صعودی و استوار | **13,932,800 میلیون ریال** (معادل **1.39 همت** / 13,932,800,000,000 ریال) | افزایش حجم واسطه‌گری وجوه، تولید و درآمدهای کارمزدی |
| **سود عملیاتی (Operating Profit)** | پرقدرت | **3,761,856 میلیون ریال** (معادل **376.2 میلیارد تومان** / 3,761,856,000,000 ریال) | سود عملیاتی با حاشیه 27.0% منعکس‌کننده کیفیت سودآوری است |
| **سود خالص (Net Income)** | پایدار | **2,679,385 میلیون ریال** (معادل **267.9 میلیارد تومان** / 2,679,384,615,385 ریال) | سود خالص با حاشیه 19.2% نشان‌دهنده جریان نقد واقعی پایدار است |
...
- **حقوق صاحبان سهام / ارزش دفتری (Equity):** **6,220,000 میلیون ریال** (معادل **622.0 میلیارد تومان** / 6,220,000,000,000 ریال)
