...
**آخرین قیمت معاملاتی:** 17,120 ریال | **دامنه روز:** 17,000 تا 17,300 ریال  
**حجم معاملات آخرین روز:** 2,450,000 برگه سهم (میانگین ۲۰ روزه: 45,650,286)
...
- **دامنه نوسان واقعی (ATR 14):** 479 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,536 | +3.5% | حمایت پویا |
| **EMA 50** | 15,820 | +8.2% | حمایت میان‌مدت |
| **EMA 100** | 14,746 | +16.1% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,483 | +27.0% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 17,644 ریال
- **باند میانی (SMA 20):** 16,483 ریال
- **باند پایینی (Lower Band):** 15,322 ریال
- **عرض باند (Bandwidth):** 14.1% (سنجش میزان فشردگی نوسانات)
...
- **ابر کومو اسپن B (Senkou Span B):** 14,463 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **61.3** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 405.83 | **خط سیگنال:** 319.80 | **هیستوگرام:** 86.02
...
| :--- | :--- | :--- | :--- |
| **0.0** | 17,728 | -3.4% | سقف موج (Pivot High) |
| **0.236** | 15,961 | +7.3% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,868 | +15.1% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,984 | +22.4% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,100 | +30.7% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,842 | +44.6% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +67.2% | کف موج (Pivot Low) |
...
- **نسبت قدرت خریدار به فروشنده:** **1.04** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 5,968 سهم | **سرانه فروش حقیقی:** 5,735 سهم
- **حجم خرید حقیقی:** 1,850,000 سهم | **حجم خرید حقوقی:** 600,000 سهم
- **حجم فروش حقیقی:** 1,950,000 سهم | **حجم فروش حقوقی:** 500,000 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,120 ریال** در مقایسه با میانگین ۲۰ روزه (16,536 ریال) و میانگین ۵۰ روزه (15,820 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **61.3** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+86.02** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **1.04** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **5,968 سهم** ثبت گردیده است.
