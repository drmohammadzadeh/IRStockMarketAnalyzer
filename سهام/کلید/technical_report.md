...
**آخرین قیمت معاملاتی:** 18,118 ریال | **دامنه روز:** 17,751 تا 18,296 ریال  
**حجم معاملات آخرین روز:** 121,125,539 برگه سهم (میانگین ۲۰ روزه: 63,974,667)
...
- **سقف ماژور دوره (Swing High):** 18,296 ریال
- **کف ماژور دوره (Swing Low):** 10,240 ریال
- **دامنه نوسان واقعی (ATR 14):** 541 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,956 | +6.9% | حمایت پویا |
| **EMA 50** | 16,137 | +12.3% | حمایت میان‌مدت |
| **EMA 100** | 15,013 | +20.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,681 | +32.4% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,238 ریال
- **باند میانی (SMA 20):** 16,768 ریال
- **باند پایینی (Lower Band):** 15,298 ریال
- **عرض باند (Bandwidth):** 17.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,462 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,728 ریال
- **ابر کومو اسپن A (Senkou Span A):** 15,354 ریال
- **ابر کومو اسپن B (Senkou Span B):** 15,274 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **71.2** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند))
- **مکدی (MACD 12,26,9):** 503.45 | **خط سیگنال:** 403.58 | **هیستوگرام:** 99.87
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 10,240 و سقف 18,296 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 18,296 | -1.0% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +10.5% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 15,219 | +19.1% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 14,268 | +27.0% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,317 | +36.0% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,964 | +51.4% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +76.9% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **16,395 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **18,296 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.77** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی)
- **سرانه خرید حقیقی:** 78,325 سهم | **سرانه فروش حقیقی:** 101,711 سهم
- **حجم خرید حقیقی:** 57,255,930 سهم | **حجم خرید حقوقی:** 3,071,260 سهم
- **حجم فروش حقیقی:** 57,975,023 سهم | **حجم فروش حقوقی:** 2,352,167 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **18,118 ریال** در مقایسه با میانگین ۲۰ روزه (16,956 ریال) و میانگین ۵۰ روزه (16,137 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **71.2** (اشباع خرید (احتمال شناسایی سود یا استراحت موقت روند)) است و هیستوگرام مکدی در وضعیت **+99.87** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.77** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **78,325 سهم** ثبت گردیده است.
