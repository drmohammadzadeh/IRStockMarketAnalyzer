...
**آخرین قیمت معاملاتی:** 17,766 ریال | **دامنه روز:** 17,650 تا 17,820 ریال  
**حجم معاملات آخرین روز:** 4,018,328 برگه سهم (میانگین ۲۰ روزه: 55,952,802)
...
- **سقف ماژور دوره (Swing High):** 17,820 ریال
- **کف ماژور دوره (Swing Low):** 10,240 ریال
- **دامنه نوسان واقعی (ATR 14):** 523 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,818 | +5.6% | حمایت پویا |
| **EMA 50** | 16,049 | +10.7% | حمایت میان‌مدت |
| **EMA 100** | 14,947 | +18.9% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,635 | +30.3% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 17,980 ریال
- **باند میانی (SMA 20):** 16,685 ریال
- **باند پایینی (Lower Band):** 15,391 ریال
- **عرض باند (Bandwidth):** 15.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,224 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,490 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **68.1** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 444.54 | **خط سیگنال:** 375.98 | **هیستوگرام:** 68.57
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 10,240 و سقف 17,820 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 17,820 | -0.3% | سقف موج (Pivot High) |
| **0.236** | 16,031 | +10.8% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,924 | +19.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 14,030 | +26.6% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,136 | +35.3% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,862 | +49.8% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +73.5% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **16,031 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **17,820 ریال**
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,766 ریال** در مقایسه با میانگین ۲۰ روزه (16,818 ریال) و میانگین ۵۰ روزه (16,049 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **68.1** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+68.57** نوسان می‌کند.
