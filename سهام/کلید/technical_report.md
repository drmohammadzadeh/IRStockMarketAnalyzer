...
**آخرین قیمت معاملاتی:** 18,010 ریال | **دامنه روز:** 17,730 تا 18,128 ریال  
**حجم معاملات آخرین روز:** 81,754,855 برگه سهم (میانگین ۲۰ روزه: 67,877,627)
...
- **دامنه نوسان واقعی (ATR 14):** 566 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 17,133 | +5.1% | حمایت پویا |
| **EMA 50** | 16,274 | +10.7% | حمایت میان‌مدت |
| **EMA 100** | 15,127 | +19.1% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,765 | +30.8% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,505 ریال
- **باند میانی (SMA 20):** 16,944 ریال
- **باند پایینی (Lower Band):** 15,382 ریال
- **عرض باند (Bandwidth):** 18.4% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,462 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,942 ریال
- **ابر کومو اسپن A (Senkou Span A):** 15,432 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **67.3** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 525.07 | **خط سیگنال:** 445.07 | **هیستوگرام:** 80.00
...
| :--- | :--- | :--- | :--- |
| **0.0** | 18,296 | -1.6% | سقف موج (Pivot High) |
| **0.236** | 16,395 | +9.9% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 15,219 | +18.3% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 14,268 | +26.2% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,317 | +35.2% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,964 | +50.5% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +75.9% | کف موج (Pivot Low) |
...
- **سرانه خرید حقیقی:** 95,364 سهم | **سرانه فروش حقیقی:** 121,215 سهم
- **حجم خرید حقیقی:** 98,988,071 سهم | **حجم خرید حقوقی:** 4,034,775 سهم
- **حجم فروش حقیقی:** 99,881,358 سهم | **حجم فروش حقوقی:** 3,141,488 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **18,010 ریال** در مقایسه با میانگین ۲۰ روزه (17,133 ریال) و میانگین ۵۰ روزه (16,274 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **67.3** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+80.00** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.79** (برتری فروشندگان و فشار عرضه از سوی کدهای حقیقی) با سرانه خرید **95,364 سهم** ثبت گردیده است.
