...
**آخرین قیمت معاملاتی:** 17,494 ریال | **دامنه روز:** 17,052 تا 17,664 ریال  
**حجم معاملات آخرین روز:** 80,934,917 برگه سهم (میانگین ۲۰ روزه: 57,557,962)
...
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,719 | +4.6% | حمایت پویا |
| **EMA 50** | 15,979 | +9.5% | حمایت میان‌مدت |
| **EMA 100** | 14,890 | +17.5% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,594 | +28.7% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 17,851 ریال
- **باند میانی (SMA 20):** 16,648 ریال
- **باند پایینی (Lower Band):** 15,445 ریال
- **عرض باند (Bandwidth):** 14.5% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,114 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,444 ریال
- **ابر کومو اسپن A (Senkou Span A):** 15,562 ریال
- **ابر کومو اسپن B (Senkou Span B):** 15,018 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **65.4** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 411.70 | **خط سیگنال:** 358.83 | **هیستوگرام:** 52.87
...
| :--- | :--- | :--- | :--- |
| **0.0** | 17,728 | -1.3% | سقف موج (Pivot High) |
| **0.236** | 15,961 | +9.6% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 14,868 | +17.7% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 13,984 | +25.1% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,100 | +33.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,842 | +47.7% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +70.8% | کف موج (Pivot Low) |
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,494 ریال** در مقایسه با میانگین ۲۰ روزه (16,719 ریال) و میانگین ۵۰ روزه (15,979 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **65.4** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+52.87** نوسان می‌کند.
