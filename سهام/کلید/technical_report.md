...
**آخرین قیمت معاملاتی:** 17,896 ریال | **دامنه روز:** 17,650 تا 18,000 ریال  
**حجم معاملات آخرین روز:** 41,904,938 برگه سهم (میانگین ۲۰ روزه: 57,847,133)
...
- **سقف ماژور دوره (Swing High):** 18,000 ریال
- **کف ماژور دوره (Swing Low):** 10,240 ریال
- **دامنه نوسان واقعی (ATR 14):** 536 ریال

### جدول میانگین‌های متحرک نمایی (Exponential Moving Averages)
| شاخص میانگین | مقدار عددی (ریال) | فاصله با قیمت فعلی | موقعیت تکنیکال |
| :--- | :--- | :--- | :--- |
| **EMA 20** | 16,831 | +6.3% | حمایت پویا |
| **EMA 50** | 16,055 | +11.5% | حمایت میان‌مدت |
| **EMA 100** | 14,949 | +19.7% | حمایت / مقاومت تراز میانی |
| **EMA 200** | 13,636 | +31.2% | مرز روند بلندمدت و استراتژیک |

### وضعیت باندهای بولینگر (Bollinger Bands)
- **باند بالایی (Upper Band):** 18,011 ریال
- **باند میانی (SMA 20):** 16,692 ریال
- **باند پایینی (Lower Band):** 15,373 ریال
- **عرض باند (Bandwidth):** 15.8% (سنجش میزان فشردگی نوسانات)

---

## ۲. تحلیل سیستم معاملاتی ایچیموکو (Ichimoku Kinko Hyo)
- **خط تنکان‌سن (Tenkan-sen 9):** 17,314 ریال
- **خط کیجون‌سن (Kijun-sen 26):** 16,580 ریال
- **ابر کومو اسپن A (Senkou Span A):** 15,354 ریال
- **ابر کومو اسپن B (Senkou Span B):** 15,214 ریال
...
- **شاخص قدرت نسبی (RSI 14):** **69.3** (تکانه مثبت و برتری نسبی خریداران)
- **مکدی (MACD 12,26,9):** 454.91 | **خط سیگنال:** 378.05 | **هیستوگرام:** 76.86
...
مبنای محاسبه ترازهای فیبوناچی اصلاحی بر اساس آخرین موج حرکتی بین کف 10,240 و سقف 18,000 ریال:

| نسبت فیبوناچی | سطح قیمتی (ریال) | فاصله با قیمت فعلی | نقش تکنیکال |
| :--- | :--- | :--- | :--- |
| **0.0** | 18,000 | -0.6% | سقف موج (Pivot High) |
| **0.236** | 16,169 | +10.7% | حمایت / مقاومت اول اصلاحی (23.6%) |
| **0.382** | 15,036 | +19.0% | تراز اصلاحی نرمال (38.2%) |
| **0.5** | 14,120 | +26.7% | تراز میانی تعادلی (50.0%) |
| **0.618** | 13,204 | +35.5% | تراز طلایی و پرتقاضا (61.8%) |
| **0.786** | 11,901 | +50.4% | آخرین سد دفاعی روند (78.6%) |
| **1.0** | 10,240 | +74.8% | کف موج (Pivot Low) |

- **نزدیک‌ترین سطح حمایت معتبر:** **16,169 ریال**
- **نزدیک‌ترین سطح مقاومت معتبر:** **18,000 ریال**

---

## ۵. تابلوخوانی و رفتارشناسی حقیقی/حقوقی (Tape Reading & Smart Money Flow)
- **نسبت قدرت خریدار به فروشنده:** **0.96** (تعادل نسبی میان قدرت خریدار و فروشنده)
- **سرانه خرید حقیقی:** 107,457 سهم | **سرانه فروش حقیقی:** 111,733 سهم
- **حجم خرید حقیقی:** 77,476,367 سهم | **حجم خرید حقوقی:** 3,511,735 سهم
- **حجم فروش حقیقی:** 77,542,843 سهم | **حجم فروش حقوقی:** 3,445,259 سهم
...
- **تحلیل وضعیت فعلی نماد:** آخرین قیمت در سطح **17,896 ریال** در مقایسه با میانگین ۲۰ روزه (16,831 ریال) و میانگین ۵۰ روزه (16,055 ریال) موقعیت **صعودی تثبیت‌شده (قیمت بالاتر از میانگین‌های کوتاه و میان‌مدت قرار دارد)** را ثبت کرده است.
...
- **تحلیل وضعیت فعلی نماد:** مقدار فعلی RSI برابر با **69.3** (تکانه مثبت و برتری نسبی خریداران) است و هیستوگرام مکدی در وضعیت **+76.86** نوسان می‌کند.
...
- **تحلیل وضعیت فعلی نماد:** نسبت قدرت خریدار به فروشنده سهم برابر با **0.96** (تعادل نسبی میان قدرت خریدار و فروشنده) با سرانه خرید **107,457 سهم** ثبت گردیده است.
