...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.6** | افق کوتاه‌مدت (5.2/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.48 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **16,731 تا 17,413 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **17,728 ریال** | **+3.8%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **19,501 ریال** | **+14.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **15,705 ریال** | **-8.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.48** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 17,728 ریال (بازدهی مورد انتظار: 3.8%)
- **حد ضرر:** 15,705 ریال (حداکثر ریسک: 8.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 19,501 ریال (بازدهی مورد انتظار: 14.2%)
- **حد ضرر:** 15,233 ریال (ریسک: 10.8%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 24,376 ریال (بازدهی مورد انتظار: 42.8%)
- **حد ضرر:** 14,684 ریال (ریسک: 14.0%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 60.5 - ATR: 512 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.73 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 15,705 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد کلید

- **نماد تحت ممیزی:** `کلید`
- **تاریخ صدور گواهی:** `1405/06/14 - 10:32`
