...
**آخرین قیمت معاملاتی:** 18,010 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.6** | بنیادی (8.0/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (2.5/۱۰ با وزن ۲۵٪) + اخبار (5.5/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.4** | افق کوتاه‌مدت (5.2/۱۰) + میان‌مدت (8.0/۱۰) + بلندمدت (7.8/۱۰) با ضریب R/R=0.16 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **17,650 تا 18,370 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **18,296 ریال** | **+1.6%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **20,126 ریال** | **+11.7%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **16,209 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.16** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 18,296 ریال (بازدهی مورد انتظار: 1.6%)
- **حد ضرر:** 16,209 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 20,126 ریال (بازدهی مورد انتظار: 11.7%)
- **حد ضرر:** 15,723 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 25,157 ریال (بازدهی مورد انتظار: 39.7%)
- **حد ضرر:** 15,083 ریال (ریسک: 16.3%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 67.3 - ATR: 566 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.79 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 16,209 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **نماد تحت ممیزی:** `کلید`
- **تاریخ صدور گواهی:** `1405/06/21 - 15:15`
