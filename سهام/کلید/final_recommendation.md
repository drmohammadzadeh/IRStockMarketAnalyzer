...
**آخرین قیمت معاملاتی:** 17,494 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **3.8** | بنیادی (8.0/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (4.5/۱۰ با وزن ۲۵٪) + اخبار (5.5/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.5** | افق کوتاه‌مدت (6.2/۱۰) + میان‌مدت (8.0/۱۰) + بلندمدت (7.8/۱۰) با ضریب R/R=0.13 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **17,144 تا 17,844 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **17,728 ریال** | **+1.3%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **19,501 ریال** | **+11.5%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **15,745 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
...
- **تارگت هدف:** 17,728 ریال (بازدهی مورد انتظار: 1.3%)
- **حد ضرر:** 15,745 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 19,501 ریال (بازدهی مورد انتظار: 11.5%)
- **حد ضرر:** 15,272 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 24,376 ریال (بازدهی مورد انتظار: 39.3%)
- **حد ضرر:** 14,684 ریال (ریسک: 16.1%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 65.4 - ATR: 523 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 0.85 | تعادل یا برتری عرضه |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 15,745 ریال با حجم معاملات فراتر از میانگین ماهانه.
