...
**آخرین قیمت معاملاتی:** 17,766 ریال  
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.5** | افق کوتاه‌مدت (6.2/۱۰) + میان‌مدت (8.0/۱۰) + بلندمدت (7.8/۱۰) با ضریب R/R=0.03 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **17,411 تا 18,121 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **17,820 ریال** | **+0.3%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **19,602 ریال** | **+10.3%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **15,989 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.03** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 17,820 ریال (بازدهی مورد انتظار: 0.3%)
- **حد ضرر:** 15,989 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 19,602 ریال (بازدهی مورد انتظار: 10.3%)
- **حد ضرر:** 15,510 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 24,502 ریال (بازدهی مورد انتظار: 37.9%)
- **حد ضرر:** 14,749 ریال (ریسک: 17.0%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 68.1 - ATR: 523 ریال | اشباع خرید / خنثی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 15,989 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **نماد تحت ممیزی:** `کلید`
- **تاریخ صدور گواهی:** `1405/06/16 - 09:04`
