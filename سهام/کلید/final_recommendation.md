...
**آخرین قیمت معاملاتی:** 17,151 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.0** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (8.0/۱۰ با وزن ۳۰٪) + تابلوخوانی (4.5/۱۰ با وزن ۲۵٪) + اخبار (5.5/۱۰ با وزن ۱۰٪) |
| **رویکرد ۲: مدل درخت تصمیم و فیلترهای وتو** | **4.0** | گیت مساعد: ارزندگی بنیادی مطلوب و حمایت خریداران حقیقی |
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **3.7** | افق کوتاه‌مدت (6.2/۱۰) + میان‌مدت (8.8/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.40 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **16,808 تا 17,494 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **17,728 ریال** | **+3.4%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **19,501 ریال** | **+13.7%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **15,706 ریال** | **-8.4%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.4** | — | 🔴 نامناسب (R/R < 1.5) |
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 61.4 - ATR: 509 ریال | اشباع خرید / خنثی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 15,706 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- **نماد تحت ممیزی:** `کلید`
- **تاریخ صدور گواهی:** `1405/06/15 - 17:50`
