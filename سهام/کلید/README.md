...
> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/17 - 17:25  
...
| **آخرین قیمت معامله** | **17,896 ریال** | ثبت نوسانات پایان بازار 1405/06/16 |
| **محدوده خرید بهینه** | **17,538 تا 18,254 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **18,000 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **19,800 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **16,106 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.06** | 🔴 نیازمند احتیاط (R/R < 1.5) |
