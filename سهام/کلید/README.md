...
| **آخرین قیمت معامله** | **17,120 ریال** | ثبت نوسانات پایان بازار ۱۴۰۵/۰۶/۱۰ |
| **محدوده خرید بهینه** | **16,778 تا 17,462 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **17,728 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **19,501 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **15,721 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.43** | 🔴 نیازمند احتیاط (R/R < 1.5) |
