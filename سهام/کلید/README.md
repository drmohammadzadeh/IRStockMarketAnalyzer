...
| **آخرین قیمت معامله** | **18,118 ریال** | ثبت نوسانات پایان بازار 1405/06/17 |
| **محدوده خرید بهینه** | **17,756 تا 18,480 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **20,836 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **23,553 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **16,579 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **1.77** | 🟡 مناسب (R/R >= 1.5) |
