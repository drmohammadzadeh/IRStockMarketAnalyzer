# 📊 شناسنامه و داشبورد تحلیلی نماد کلید (صندوق املاک و مستغلات کلید)

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/21 - 15:15  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «کلید»**  
...
| :--- | :--- |
| **نماد معاملاتی** | **کلید** |
| **نام شرکت / دارایی** | صندوق املاک و مستغلات کلید |
| **بازار معاملاتی** | بورس / فرابورس اوراق بهادار تهران |
| **سابقه معاملاتی** | **394 روز معاملاتی** در سامانه TSETMC |
| **وضعیت تابلو و صف** | معاملات تعادلی در محدوده NAV |
...
| **امتیاز هوش مصنوعی (TJB24.ir AI Score)** | **۶.۵ از ۱۰ (سطح ۶)** | 🟡 سیگنال نگهداری (بنیادی: ۸.۰، تکنیکال: ۸.۰، سنتیمنت: ۳.۴، ریسک پایین: ۵.۲) |
| **آخرین قیمت معامله** | **18,010 ریال** | ثبت نوسانات پایان بازار 1405/06/21 |
| **محدوده خرید بهینه** | **17,650 تا 18,370 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **18,296 ریال** | مقاومت اول و هدف نوسانی |
| **حد سود دوم (میان‌مدت)** | **20,126 ریال** | سقف کانال ماژور و مقاومت کلیدی |
| **حد ضرر پویا (Dynamic SL)** | **16,209 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.16** | 🔴 نیازمند احتیاط (R/R < 1.5) |
| **قدرت خریدار حقیقی** | **1.04** | تعادل خریدار و فروشنده |
