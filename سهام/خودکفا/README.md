# 📊 شناسنامه و داشبورد تحلیلی نماد خودکفا (شرکت اقتصادی و خودکفائی آزادگان)

> **📅 تاریخ و ساعت آخرین بروزرسانی:** 1405/06/17 - 12:24  
> **نویسنده و توسعه دهنده:** [tjb24.ir](https://tjb24.ir)  
> **خلاصه جامع وضعیت معاملاتی، ارزیابی بنیادی، صورت‌های مالی، تابلوخوانی و استراتژی ورود/خروج برای نماد «خودکفا»**  
> *تهیه‌شده توسط سامانه تحلیل چندعاملی بازار سرمایه ایران (IRStockMarketAnalyzer)*  
> *تاریخ آخرین به‌روزرسانی بر مبنای آخرین معاملات بازار:* 1405/06/17 - 17:15  
...
| مشخصه | شرح |
| :--- | :--- |
| **نماد معاملاتی** | **خودکفا** |
| **نام شرکت / دارایی** | شرکت اقتصادی و خودکفائی آزادگان (گروه مینو) |
| **بازار معاملاتی** | فرابورس ایران (بازار دوم) |
| **سابقه معاملاتی** | **۲,۴۱۱ روز معاملاتی** در سامانه TSETMC |
| **وضعیت تابلو و صف** | تقاضای پرقدرت خریداران حقیقی و ورود پول هوشمند |
| **صنعت و گروه** | سرمایه‌گذاری‌ها و هلدینگ‌های چندرشته‌ای صنایع غذایی و دارویی |
...
| **آخرین قیمت معامله** | **15,670 ریال** | ثبت نوسانات پایان بازار 1405/06/17 |
| **محدوده خرید بهینه** | **15,357 تا 15,983 ریال** | بازه ورود پله‌ای کنترل‌شده با مدیریت ریسک |
| **حد سود اول (کوتاه‌مدت)** | **15,700 ریال** | مقاومت اول و هدف نوسانی کوتاه‌مدت |
| **حد سود دوم (میان‌مدت)** | **17,270 ریال** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic SL)** | **14,103 ریال** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.02** | 🔴 نامناسب (R/R < 1.5) |
| **قدرت خریدار حقیقی** | **2.56** | ورود پول هوشمند و برتری قاطع خریداران حقیقی (سرانه خرید ۸۹ هزار سهم در برابر فروش ۳۵ هزار سهم) |
...
## 📂 ساختار گزارش‌ها و فایل‌های استخراج‌شده نماد خودکفا

- 📄 [**README.md**](README.md): شناسنامه جامع و داشبورد مدیریتی نماد
- 🎯 [**final_recommendation.md**](final_recommendation.md): راهنمای جامع پیشنهاد معاملاتی، مدیریت ریسک و گواهی داوری
- 📑 [**fundamental_report.md**](fundamental_report.md): گزارش فوق‌تفصیلی بنیادی، صورت‌های مالی، ارزیابی P/NAV و بررسی پورتفوی هلدینگ
- 📈 [**technical_report.md**](technical_report.md): گزارش فوق‌تفصیلی تکنیکال، اسیلاتورها، ایچیموکو، فیبوناچی و تابلوخوانی
- 📝 [**executive_summary.md**](executive_summary.md): چکیده وضعیت و سنتز تک‌پاراگرافی وضعیت نماد
