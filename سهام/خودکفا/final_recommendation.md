# جمع‌بندی تحلیلی و پیشنهاد معاملاتی نماد خودکفا
...
**آخرین قیمت معاملاتی:** 15,670 ریال  
...
| :--- | :---: | :--- |
| **رویکرد ۱: مدل تجمیع وزنی چندعاملی** | **4.5** | بنیادی (9.5/۱۰ با وزن ۳۵٪) + تکنیکال (7.5/۱۰ با وزن ۳۰٪) + تابلوخوانی (10.0/۱۰ با وزن ۲۵٪) + اخبار (6.8/۱۰ با وزن ۱۰٪) |
...
| **رویکرد ۳: مدل همگرایی افق‌های زمانی و R/R** | **4.0** | افق کوتاه‌مدت (8.8/۱۰) + میان‌مدت (8.5/۱۰) + بلندمدت (8.8/۱۰) با ضریب R/R=0.02 |
...
| :--- | :--- | :--- | :--- |
| **محدوده خرید بهینه (Entry Zone)** | **15,357 تا 15,983 ریال** | — | بازه ورود مجاز و منطقی برای ورود پله‌ای |
| **حد سود اول (Target 1)** | **15,700 ریال** | **+0.2%** | مقاومت اول و هدف نوسان‌گیری کوتاه‌مدت |
| **حد سود دوم (Target 2)** | **17,270 ریال** | **+10.2%** | سقف کانال ماژور و مقاومت کلیدی میان‌مدت |
| **حد ضرر پویا (Dynamic Stop Loss)** | **14,103 ریال** | **-10.0%** | سطح شکست حمایت پیوت با ضریب نوسان ATR |
| **نسبت سود به ریسک (R/R)** | **0.02** | — | 🔴 نامناسب (R/R < 1.5) |
...
- **تارگت هدف:** 15,700 ریال (بازدهی مورد انتظار: 0.2%)
- **حد ضرر:** 14,103 ریال (حداکثر ریسک: 10.0%)

### ۲. میان‌مدت (۱ تا ۳ ماه)
- **استراتژی اجرایی:** بهره‌گیری از شکست الگوهای ماژور و گزارش‌های فعالیت ماهانه کدال
- **تارگت هدف:** 17,270 ریال (بازدهی مورد انتظار: 10.2%)
- **حد ضرر:** 13,680 ریال (ریسک: 12.7%)

### ۳. بلندمدت (۶ تا ۱۲ ماه)
- **استراتژی اجرایی:** دید بنیادی و سرمایه‌گذاری بر پایه ارزش ذاتی، P/E رو به جلو و سود تقسیمی مجمع (DPS)
- **تارگت هدف:** 21,588 ریال (بازدهی مورد انتظار: 37.8%)
- **حد ضرر:** 12,405 ریال (ریسک: 20.8%)
...
| :--- | :--- | :--- |
| **تحلیل تکنیکال** | شاخص RSI: 70.7 - ATR: 591 ریال | اشباع خرید / خنثی |
| **تابلوخوانی و جریان پول** | سرانه قدرت خریدار به فروشنده: 2.56 | ورود پول هوشمند و تقاضای قوی |
...
## شروط ابطال تحلیل
- تثبیت کندل روزانه زیر قیمت 14,103 ریال با حجم معاملات فراتر از میانگین ماهانه.
...
- شکست قطعی کف سوئینگ ماژور در محدوده 6,310 ریال.
...
# 🏛️ گواهی رسمی داوری و ممیزی نهایی نماد خودکفا

- **نماد تحت ممیزی:** `خودکفا`
- **تاریخ صدور گواهی:** `1405/06/17 - 12:24`
