...
> **📅 تاریخ و ساعت آخرین بروزرسانی: 1405/06/15 - 17:50** 1405/06/15 - 17:50  
...
> **تاریخ به‌روزرسانی سراسری و ممیزی داور:** 1405/06/14 - 14:52  
...
| :---: | :---: | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| 1 | [**تابان**](سهام/تابان/README.md) | گروه پتروشیمی تابان فردا | **4.7** | **5.0** | **4.7** | **4.8 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)** | **10.0** | 🛡️ تأیید ممیزی | نسبت P/NAV حدود ۴۰٪، تخفیف ۶۰٪ در عرضه اولیه، حداقل بازدهی تضمین‌شده ۴۰٪ سالانه |
| 2 | [**زهلال**](سهام/زهلال/README.md) | کشت و صنعت و دامپروری صنایع غذایی هلال (کشت و صنعت هلال) | **4.6** | **5.0** | **4.0** | **4.5 از ۵ (★★★★★)** | **🚀 خرید قاطع (Strong Buy)** | **10.0** | 🛡️ تأیید ممیزی | رشد ۲۰۱٪ فروش ۵ ماهه (۶۴۵ میلیارد تومان)، مزایده موفق ۹۰ هکتار باغات پسته، سودآوری نقدی از فروش روزانه شیر خام در صنعت زراعت |
| 3 | [**بانیان**](سهام/بانیان/README.md) | صندوق املاک و مستغلات بانیان مسکن | **3.8** | **4.0** | **4.3** | **4.0 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | دارایی‌های ملکی مرغوب، جریان درآمد اجاره باثبات، جذابیت تخفیف نسبت به ارزش روز املاک |
| 4 | [**کلید**](سهام/کلید/README.md) | صندوق املاک و مستغلات کلید | **4.0** | **4.0** | **3.7** | **3.9 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | پورتفوی املاک فیزیکی ۶۹۵ میلیارد تومانی، مازاد تجدید ارزیابی ۲۵۸ میلیارد تومانی، پوشش تورمی |
| 5 | [**تلیسه**](سهام/تلیسه/README.md) | دامداری تلیسه نمونه | **3.8** | **4.0** | **3.6** | **3.8 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | سودآوری عملیاتی مطلوب، قیمت منصفانه، نوسان طبیعی در اصلاح مقطعی بازار |
| 6 | [**خودرو**](سهام/خودرو/README.md) | ایران خودرو | **3.8** | **4.0** | **3.6** | **3.8 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | تراکم قیمت در محدوده میانگین‌ها، زیان انباشته تاریخی، مشروط به آزادسازی نرخ و تجدید ارزیابی |
| 7 | [**فسازان**](سهام/فسازان/README.md) | غلتک‌سازان سپاهان | **3.8** | **4.0** | **3.5** | **3.8 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | رشد فروش شمش و قطعات چدنی، صادرات‌محور، ارزش بازاری مناسب نسبت به دارایی‌ها |
| 8 | [**غمهرا**](سهام/غمهرا/README.md) | گروه تولیدی مهرام | **3.6** | **4.0** | **3.4** | **3.7 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | برند پیشرو و باسابقه صنایع غذایی و سس‌ها، سلامت مالی بالا و حاشیه سود پایدار، رشد مستمر فروش ماهانه |
| 9 | [**وتجارت**](سهام/وتجارت/README.md) | بانک تجارت | **3.6** | **4.0** | **3.3** | **3.6 از ۵ (★★★★☆)** | **🟢 خرید / ورود پله‌ای (Buy)** | **10.0** | 🛡️ تأیید ممیزی | اصلاح قیمتی در صف فروش پایان بازار، بنیاد مطلوب بانکی، افت RSI به فاز تعادل، انتظار جمع‌آوری صف |
...
| :---: | :--- | :---: | :---: | :--- |
| **تابان** | گروه پتروشیمی تابان فردا | **🚀 خرید قاطع (Strong Buy)** (4.8 از ۵ ★★★★★) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری تابان](سهام/تابان/README.md) |
...
| **کلید** | صندوق املاک و مستغلات کلید | **🟢 خرید / ورود پله‌ای (Buy)** (3.9 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری کلید](سهام/کلید/README.md) |
| **تلیسه** | دامداری تلیسه نمونه | **🟢 خرید / ورود پله‌ای (Buy)** (3.8 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری تلیسه](سهام/تلیسه/README.md) |
| **خودرو** | ایران خودرو | **🟢 خرید / ورود پله‌ای (Buy)** (3.8 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری خودرو](سهام/خودرو/README.md) |
| **فسازان** | غلتک‌سازان سپاهان | **🟢 خرید / ورود پله‌ای (Buy)** (3.8 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری فسازان](سهام/فسازان/README.md) |
| **غمهرا** | گروه تولیدی مهرام | **🟢 خرید / ورود پله‌ای (Buy)** (3.7 از ۵ ★★★★☆) | **10.0/10** | [مشاهده شناسنامه و گواهی داوری غمهرا](سهام/غمهرا/README.md) |
